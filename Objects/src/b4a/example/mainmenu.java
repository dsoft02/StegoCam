...
public class mainmenu extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.mainmenu");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.mainmenu");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.mainmenu", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
try { //BA.debugLineNum = 32;BA.debugLine="Drawer.Initialize(Me, \"Drawer\", Activity, 270dip";
mostCurrent._drawer._initialize /*String*/ (mostCurrent.activityBA,mainmenu.getObject(),"Drawer",(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (270)));
 //BA.debugLineNum = 33;BA.debugLine="Drawer.CenterPanel.LoadLayout(\"mainmenu\")";
mostCurrent._drawer._getcenterpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().LoadLayout("mainmenu",mostCurrent.activityBA);
 //BA.debugLineNum = 34;BA.debugLine="ToolbarHelper.Initialize";
mostCurrent._toolbarhelper.Initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 35;BA.debugLine="ToolbarHelper.ShowUpIndicator = True 'set to tru";
mostCurrent._toolbarhelper.setShowUpIndicator(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 36;BA.debugLine="ToolbarHelper.UpIndicatorDrawable = config.Bitma";
...
mostCurrent._actoolbarlight1.InitMenuListener();
 //BA.debugLineNum = 38;BA.debugLine="Drawer.LeftPanel.LoadLayout(\"leftmenu\")";
mostCurrent._drawer._getleftpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().LoadLayout("leftmenu",mostCurrent.activityBA);
 //BA.debugLineNum = 39;BA.debugLine="load_Images";
_load_images();
 } 
       catch (Exception e11) {
			processBA.setLastException(e11); //BA.debugLineNum = 41;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("61638412",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 ...
 //BA.debugLineNum = 59;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK And Drawer.Lef";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK && mostCurrent._drawer._getleftopen /*boolean*/ ()) { 
 //BA.debugLineNum = 60;BA.debugLine="Drawer.LeftOpen = False";
...
public static String  _actoolbarlight1_menuitemclick(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 66;BA.debugLine="Private Sub ACToolBarLight1_MenuItemClick (Item As";
 //BA.debugLineNum = 68;BA.debugLine="End Sub";
return "";
}
public static String  _actoolbarlight1_navigationitemclick() throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub ACToolBarLight1_NavigationItemClick";
 //BA.debugLineNum = 55;BA.debugLine="Drawer.LeftOpen = Not(Drawer.LeftOpen)";
...
public ResumableSub_lb1Menu_Click(b4a.example.mainmenu parent) {
this.parent = parent;
}
b4a.example.mainmenu parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 84;BA.debugLine="If Drawer.LeftOpen Then Drawer.LeftOpen = False";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 85;BA.debugLine="Sleep(10)";
...
public ResumableSub_lb2Menu_Click(b4a.example.mainmenu parent) {
this.parent = parent;
}
b4a.example.mainmenu parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 79;BA.debugLine="If Drawer.LeftOpen Then Drawer.LeftOpen = False";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 80;BA.debugLine="Sleep(150)";
...
public ResumableSub_lb3Menu_Click(b4a.example.mainmenu parent) {
this.parent = parent;
}
b4a.example.mainmenu parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 88;BA.debugLine="If Drawer.LeftOpen Then Drawer.LeftOpen = False";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 89;BA.debugLine="Sleep(10)";
anywheresoftware.b4a.keywords.Common.Sleep(mostCurrent.activityBA,this,(int) (10));
this.state = 7;
return;
case 7:
...
this.state = -1;
;
 //BA.debugLineNum = 90;BA.debugLine="MsgboxAsync(\"Application developed by Abdul Cadre";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence("Application developed by Abdul Cadre Hassamo in the scope of * Recruitment Challenge * made by Wit. "+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+" The application should show time at the current location and 10 European cities, for this I used bridges (JSON APIs) to obtain such data. "+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"Used APIs:"+anywheresoftware.b4a.keywords.Common.CRLF+"Meteorological Data: http://openweathermap.org/api"+anywheresoftware.b4a.keywords.Common.CRLF+"Lista do countries: http://vocab.nic.in/rest.php/country/json"+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"Eventual contacts I place the layout: achassamo@gmail.com | +258840122758 "),BA.ObjectToCharSequence(" About the application "),processBA);
...
public static String  _load_images() throws Exception{
 //BA.debugLineNum = 71;BA.debugLine="Sub load_Images";
 //BA.debugLineNum = 72;BA.debugLine="config.AjustImageView(ic1Menu,File.DirAssets,\"ico";
mostCurrent._config._ajustimageview /*String*/ (mostCurrent.activityBA,mostCurrent._ic1menu,anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"icons8_moisture_96px.png");
 //BA.debugLineNum = 73;BA.debugLine="config.AjustImageView(ic2Menu,File.DirAssets,\"ico";
mostCurrent._config._ajustimageview /*String*/ (mostCurrent.activityBA,mostCurrent._ic2menu,anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"icons8_content_96px.png");
 //BA.debugLineNum = 74;BA.debugLine="config.AjustImageView(ic3Menu,File.DirAssets,\"ico";
mostCurrent._config._ajustimageview /*String*/ (mostCurrent.activityBA,mostCurrent._ic3menu,anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"icons8_info_96px.png");
