...
vis = vis | (leftmenu.mostCurrent != null);
return vis;}
...
parent.mostCurrent._activity.LoadLayout("splash",mostCurrent.activityBA);
 //BA.debugLineNum = 32;BA.debugLine="imgIcon.SetBitmap(xui.LoadBitmapResize(File.DirAs";
parent.mostCurrent._imgicon.SetBitmap((android.graphics.Bitmap)(parent._xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"stegocam_ico.png",parent.mostCurrent._imgicon.getWidth(),parent.mostCurrent._imgicon.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 //BA.debugLineNum = 33;BA.debugLine="Sleep(3000)";
...
this.state = -1;
;
 //BA.debugLineNum = 34;BA.debugLine="StartActivity(mainmenu)";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 26;BA.debugLine="Private imgIcon As B4XView";
mostCurrent._imgicon = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Dim splashTimer As Timer";
...
public static String  _mytimer_tick() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub myTimer_tick";
 //BA.debugLineNum = 50;BA.debugLine="splashTimer.Enabled=False";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 52;BA.debugLine="StartActivity(mainmenu)";
