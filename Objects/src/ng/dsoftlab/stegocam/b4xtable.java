...
public class b4xtable extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.b4xtable");
            if (htSubs == null) {
...
public ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn  _addcolumn(String _title,int _columntype) throws Exception{
...
_c.Formatter /*ng.dsoftlab.stegocam.b4xformatter*/  = _defaultdataformatter;
...
public String  _addcolumntoclv(ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn _c) throws Exception{
...
public ResumableSub_CellClicked(ng.dsoftlab.stegocam.b4xtable parent,anywheresoftware.b4a.objects.B4XViewWrapper _pnl,boolean _longclicked) {
this.parent = parent;
this._pnl = _pnl;
...
public String  _checkandremovecolumnthatwasaddedtoincorrectparent(ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn _c,boolean _isfrozen) throws Exception{
...
public ResumableSub_Clear(ng.dsoftlab.stegocam.b4xtable parent) {
this.parent = parent;
}
ng.dsoftlab.stegocam.b4xtable parent;
...
public String  _columntosqltype(ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn _c) throws Exception{
...
public String  _createcolumnlayouts(ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn _c,int _size) throws Exception{
int _i = 0;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
...
public ResumableSub_DesignerCreateView(ng.dsoftlab.stegocam.b4xtable parent,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) {
this.parent = parent;
this._base = _base;
this._lbl = _lbl;
this._props = _props;
...
public ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn  _getcolumn(String _columnid) throws Exception{
ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn _c = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getlabelfromcolumn(ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn _c,int _index) throws Exception{
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
...
public String  _headerclicked(ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn _col) throws Exception{
ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn _c = null;
...
public ResumableSub_ImplUpdateDataFromQuery(ng.dsoftlab.stegocam.b4xtable parent,String _query,Object _args,int _totalcount,boolean _dontsleep) {
this.parent = parent;
this._query = _query;
this._args = _args;
...
_c.Formatter /*ng.dsoftlab.stegocam.b4xformatter*/ ._formatlabel /*String*/ (_rs.GetDouble(_c.SQLID /*String*/ ),_lbl);
 if (true) break;
...
_c = (ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn)(_visiblecolumns.Get(_i));
...
public String  _removecolumnfromclv(ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn _c) throws Exception{
int _i = 0;
...
if ((_c).equals((ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn)(_clvdata._getvalue(_clvindex))) == false) { 
...
public String  _resizecolumnimpl(ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn _c,int _totalheight) throws Exception{
float _height = 0f;
int _topint = 0;
int _heightint = 0;
int _i = 0;
...
public ResumableSub_SearchField_TextChanged(ng.dsoftlab.stegocam.b4xtable parent,String _old,String _new) {
this.parent = parent;
this._old = _old;
this._new = _new;
}
...
public ResumableSub_SetData(ng.dsoftlab.stegocam.b4xtable parent,anywheresoftware.b4a.objects.collections.List _data) {
this.parent = parent;
this._data = _data;
}
ng.dsoftlab.stegocam.b4xtable parent;
