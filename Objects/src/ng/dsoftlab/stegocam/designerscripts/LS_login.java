...
views.get("lblshowpassword").vw.setTop((int)((views.get("user_panel").vw.getHeight())/2d-(views.get("lblshowpassword").vw.getHeight())/2d));
views.get("imgicon").vw.setLeft((int)((views.get("pnlcontainer").vw.getWidth())/2d-(views.get("imgicon").vw.getWidth())/2d));
views.get("imgfingerprint").vw.setLeft((int)((views.get("pnlcontainer").vw.getWidth())/2d-(views.get("imgfingerprint").vw.getWidth())/2d));
