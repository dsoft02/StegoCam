...
public class bctoast extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.bctoast");
            if (htSubs == null) {
...
public ResumableSub_Show(ng.dsoftlab.stegocam.bctoast parent,String _message) {
this.parent = parent;
...
parent._bb1._parsedata /*ng.dsoftlab.stegocam.bbcodeparser._bbcodeparsedata*/ .DefaultColor /*int*/  = parent._defaulttextcolor;
