...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.b4xtimedtemplate");
            if (htSubs == null) {
...
public ResumableSub_Show(ng.dsoftlab.stegocam.b4xtimedtemplate parent,ng.dsoftlab.stegocam.b4xdialog _dialog) {
this.parent = parent;
