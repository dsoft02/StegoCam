...
public class b4xbytesbuilder extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.b4xbytesbuilder");
            if (htSubs == null) {
...
public ng.dsoftlab.stegocam.b4xbytesbuilder  _append(byte[] _data) throws Exception{
...
public ng.dsoftlab.stegocam.b4xbytesbuilder  _append2(byte[] _data,int _startindex,int _length) throws Exception{
int _oldlength = 0;
...
if (_index>_mlength) { 
__c.LogImpl("916908290","Index too large",0);};
...
if (_index>_mlength) { 
__c.LogImpl("916973826","Index too large",0);};
