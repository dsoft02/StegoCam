...
public class b4xswitch extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.b4xswitch");
            if (htSubs == null) {
...
public ResumableSub_SetValueImpl(ng.dsoftlab.stegocam.b4xswitch parent,boolean _b,boolean _immediate) {
this.parent = parent;
this._b = _b;
