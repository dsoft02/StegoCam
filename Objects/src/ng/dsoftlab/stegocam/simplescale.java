...
__c.LogImpl("315859713","Iniciando EscalarViewsFromLayout "+" freeX = "+" layoutvalues = "+BA.ObjectToString(_layvalues),0);
 //BA.debugLineNum = 202;BA.debugLine="Log(\"Numero de views: \" & container.NumberOfViews";
__c.LogImpl("315859723","Numero de views: "+BA.NumberToString(_container.getNumberOfViews()),0);
...
__c.LogImpl("315859736","Erro ao acessar posicoes da suposta view: "+BA.ObjectToString(_v),0);
 };
 };
...
__c.LogImpl("315466509","Erro ao acessar posicoes da suposta view: "+BA.ObjectToString(_v),0);
 };
 };
 }
};
...
__c.LogImpl("315794204","Layout width = "+BA.NumberToString(_layvalues.Width),0);
 //BA.debugLineNum = 166;BA.debugLine="Log (\"Layout height = \" & layValues.Height)";
__c.LogImpl("315794205","Layout height = "+BA.NumberToString(_layvalues.Height),0);
...
__c.LogImpl("315794214","ratiox = "+BA.NumberToString(_ratiox),0);
 //BA.debugLineNum = 176;BA.debugLine="Log (\"ratioy = \" & ratioy)";
__c.LogImpl("315794215","ratioy = "+BA.NumberToString(_ratioy),0);
