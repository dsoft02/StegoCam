...
__c.LogImpl("449348609","Iniciando EscalarViewsFromLayout "+" freeX = "+" layoutvalues = "+BA.ObjectToString(_layvalues),0);
 //BA.debugLineNum = 202;BA.debugLine="Log(\"Numero de views: \" & container.NumberOfViews";
__c.LogImpl("449348619","Numero de views: "+BA.NumberToString(_container.getNumberOfViews()),0);
...
__c.LogImpl("449348632","Erro ao acessar posicoes da suposta view: "+BA.ObjectToString(_v),0);
 };
 };
...
__c.LogImpl("448955405","Erro ao acessar posicoes da suposta view: "+BA.ObjectToString(_v),0);
 };
 };
 }
};
...
__c.LogImpl("449283100","Layout width = "+BA.NumberToString(_layvalues.Width),0);
 //BA.debugLineNum = 166;BA.debugLine="Log (\"Layout height = \" & layValues.Height)";
__c.LogImpl("449283101","Layout height = "+BA.NumberToString(_layvalues.Height),0);
...
__c.LogImpl("449283110","ratiox = "+BA.NumberToString(_ratiox),0);
 //BA.debugLineNum = 176;BA.debugLine="Log (\"ratioy = \" & ratioy)";
__c.LogImpl("449283111","ratioy = "+BA.NumberToString(_ratioy),0);
