...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.b4xformatter");
            if (htSubs == null) {
...
public String  _addformatdata(ng.dsoftlab.stegocam.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public ng.dsoftlab.stegocam.b4xformatter._b4xformatdata  _copyformatdata(ng.dsoftlab.stegocam.b4xformatter._b4xformatdata _data) throws Exception{
...
public ng.dsoftlab.stegocam.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
ng.dsoftlab.stegocam.b4xformatter._b4xformatdata _d = null;
...
public ng.dsoftlab.stegocam.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (ng.dsoftlab.stegocam.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return null;
}
public ng.dsoftlab.stegocam.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
ng.dsoftlab.stegocam.b4xformatter._b4xformatdata _d = null;
...
_d = (ng.dsoftlab.stegocam.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public ng.dsoftlab.stegocam.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
