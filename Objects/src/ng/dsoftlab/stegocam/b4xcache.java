...
public class b4xcache extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.b4xcache");
            if (htSubs == null) {
...
public ng.dsoftlab.stegocam.b4xcache._b4xcacheitem  _createb4xcacheitem(Object _value,String _key) throws Exception{
...
_ci = (ng.dsoftlab.stegocam.b4xcache._b4xcacheitem)(_data._get /*Object*/ ((Object)(_key)));
...
_data._remove /*String*/ ((Object)(((ng.dsoftlab.stegocam.b4xcache._b4xcacheitem)(_values.Get(_i))).Key /*String*/ ));
 }
};
 };
