...
public class bbcodeview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.bbcodeview");
            if (htSubs == null) {
...
if (_parsedata.URLs /*anywheresoftware.b4a.objects.collections.Map*/ .ContainsKey((Object)(_st.Run /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ ))) { 
...
if (_urltolines.ContainsKey((Object)(_st.Run /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ ))==__c.False) { 
...
_urltolines.Put((Object)(_st.Run /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ ),(Object)(_extra));
 }else {
 //BA.debugLineNum = 314;BA.debugLine="extra = URLToLines.Get(st.Run)";
_extra = (ng.dsoftlab.stegocam.bbcodeview._internalbbviewurl)(_urltolines.Get((Object)(_st.Run /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ )));
 };
...
public ng.dsoftlab.stegocam.bbcodeview._internalbbviewurl  _createbcurlextradata() throws Exception{
...
_usedimageviews = _b4xcollections._createorderedmap /*ng.dsoftlab.stegocam.b4xorderedmap*/ (ba);
 };
...
public ng.dsoftlab.stegocam.bctextengine._bctextrun  _findtouchedrun(float _x,float _y) throws Exception{
int _offsetx = 0;
int _offsety = 0;
...
_single = _mtextengine._findsinglestylesection /*ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection*/ (_paragraph,(int) (_x+_offsetx),(int) (_y+_offsety));
...
public ng.dsoftlab.stegocam.bctextengine  _gettextengine() throws Exception{
...
public boolean  _lineisvisible(ng.dsoftlab.stegocam.bctextengine._bctextline _line,int _offset,int _height) throws Exception{
...
public String  _markurl(ng.dsoftlab.stegocam.bctextengine._bctextrun _run) throws Exception{
...
_extra = (ng.dsoftlab.stegocam.bbcodeview._internalbbviewurl)(_urltolines.Get((Object)(_r)));
...
_pe = _mtextengine._tagparser /*ng.dsoftlab.stegocam.bbcodeparser*/ ._parse /*anywheresoftware.b4a.objects.collections.List*/ (_parsedata);
...
_runs = _mtextengine._tagparser /*ng.dsoftlab.stegocam.bbcodeparser*/ ._createruns /*anywheresoftware.b4a.objects.collections.List*/ (_pe,_parsedata);
 };
...
_style = _mtextengine._createstyle /*ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle*/ ();
...
_paragraph = _mtextengine._prepareforlazydrawing /*ng.dsoftlab.stegocam.bctextengine._bcparagraph*/ (_runs,_style,_sv);
...
_paragraph = _mtextengine._drawtext /*ng.dsoftlab.stegocam.bctextengine._bcparagraph*/ (_runs,_style,_foregroundimageview,_sv);
 };
...
public String  _settextengine(ng.dsoftlab.stegocam.bctextengine _b) throws Exception{
...
_markurl((ng.dsoftlab.stegocam.bctextengine._bctextrun)(__c.Null));
...
if (BA.fastSubCompare(sub, "SETTEXTENGINE"))
	return _settextengine((ng.dsoftlab.stegocam.bctextengine) args[0]);
