...
public class bbcodeparser extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.bbcodeparser");
            if (htSubs == null) {
...
public anywheresoftware.b4a.objects.collections.List  _createruns(anywheresoftware.b4a.objects.collections.List _texts,ng.dsoftlab.stegocam.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
public ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode  _createtagnode(String _tag) throws Exception{
...
public ng.dsoftlab.stegocam.bbcodeparser._bbcodetextnode  _createtextnode(String _text) throws Exception{
...
public int  _getdimensionfromtag(ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode _tag,String _key,ng.dsoftlab.stegocam.bbcodeparser._bbcodeparsedata _data) throws Exception{
String _s = "";
int _i = 0;
float _v = 0f;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getview(ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode _tag,ng.dsoftlab.stegocam.bbcodeparser._bbcodeparsedata _data) throws Exception{
String _id = "";
...
public ng.dsoftlab.stegocam.bctextengine._bctextrun  _handlelistelement(ng.dsoftlab.stegocam.bbcodeparser._bbcodetextnode _text,ng.dsoftlab.stegocam.bctextengine._bctextrun _run) throws Exception{
int _i = 0;
...
_run.TextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/  = _mtextengine._createbctextcharsfromstring /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ (BA.ObjectToString(__c.Chr(((int)0x2022)))+" ");
 }else {
...
_parent = _mtextengine._createconnectedparent /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ ();
 //BA.debugLineNum = 355;BA.debugLine="Run.TextChars = mTextEngine.CreateBCTextCharsF";
_run.TextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/  = _mtextengine._createbctextcharsfromstring /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ (BA.NumberToString((_count))+". ");
 //BA.debugLineNum = 356;BA.debugLine="Dim cr As BCConnectedRuns = parent.Extra.Get(m";
_cr = (ng.dsoftlab.stegocam.bctextengine._bcconnectedruns)(_parent.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_mtextengine._extra_connectedruns /*String*/ )));
...
_cr.ConnectedWidth /*int*/  = (int) (_mtextengine._getfontmetrics /*ng.dsoftlab.stegocam.bctextengine._bcfontmetrics*/ (_run.TextFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/ ,_run.TextColor /*int*/ ).xWidth /*int*/ *3/(double)_mtextengine._mscale /*float*/ );
...
public String  _initialize(anywheresoftware.b4a.BA _ba,ng.dsoftlab.stegocam.bctextengine _textengine) throws Exception{
innerInitialize(_ba);
...
public anywheresoftware.b4a.objects.collections.List  _parse(ng.dsoftlab.stegocam.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
public ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode  _parsetag(String _tag) throws Exception{
...
public void  _setimageview(ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode _tag,ng.dsoftlab.stegocam.bctextengine._bctextrun _run,ng.dsoftlab.stegocam.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
public ResumableSub_SetImageView(ng.dsoftlab.stegocam.bbcodeparser parent,ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode _tag,ng.dsoftlab.stegocam.bctextengine._bctextrun _run,ng.dsoftlab.stegocam.bbcodeparser._bbcodeparsedata _data) {
this.parent = parent;
this._tag = _tag;
this._run = _run;
this._data = _data;
...
//C
this.state = 9;
_j = (ng.dsoftlab.stegocam.httpjob) result[0];
;
...
public void  _jobdone(ng.dsoftlab.stegocam.httpjob _j) throws Exception{
}
public ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode  _stackpeek() throws Exception{
...
if (true) return (ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode)(_stack.Get((int) (_stack.getSize()-1)));
...
public String  _stackpush(ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode _tag) throws Exception{
...
public String  _texttorun(ng.dsoftlab.stegocam.bbcodeparser._bbcodetextnode _text,anywheresoftware.b4a.objects.collections.List _runslist,ng.dsoftlab.stegocam.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
_run = _mtextengine._createrun /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ (_text.Text /*String*/ );
...
_uu.Style /*String*/  = BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .GetDefault((Object)("style"),(Object)(_mtextengine._defaultunderlinestyle /*ng.dsoftlab.stegocam.bctextengine._bcstyledunderline*/ .Style /*String*/ )));
...
_run.TextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/  = _mtextengine._createbctextchars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ (new String[]{BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_tag.Tag /*String*/ )))},(int) (0),(int) (1));
...
_run.TextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/  = _mtextengine._createbctextcharsfromstring /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ (BA.ObjectToString(__c.Chr(_parsecodepoint(BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_tag.Tag /*String*/ )))))));
