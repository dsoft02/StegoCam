...
public class b4xsignaturetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.b4xsignaturetemplate");
            if (htSubs == null) {
...
public String  _show(ng.dsoftlab.stegocam.b4xdialog _dialog) throws Exception{
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((ng.dsoftlab.stegocam.b4xdialog) args[0]);
