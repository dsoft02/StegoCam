...
public class bctextengine extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.bctextengine");
            if (htSubs == null) {
...
if (_isunseparator((ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext)(_ltrlist.Get((int) (0))))) { 
...
if (_isunseparator((ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext)(_ltrlist.Get(_lastindex)))) { 
...
public String  _addparagraphviews(ng.dsoftlab.stegocam.bctextengine._bcparagraph _par) throws Exception{
...
public ng.dsoftlab.stegocam.bctextengine._bctextchars  _createbctextchars(String[] _buffer,int _startindex,int _length) throws Exception{
...
public ng.dsoftlab.stegocam.bctextengine._bctextchars  _createbctextcharsfromstring(String _s) throws Exception{
byte[] _b = null;
String[] _chars = null;
int _i = 0;
int _bi = 0;
...
public ng.dsoftlab.stegocam.bctextengine._bctextrun  _createconnectedparent() throws Exception{
...
public ng.dsoftlab.stegocam.bctextengine._bcglyph  _createglyph(String _c,ng.dsoftlab.stegocam.bctextengine._bcfontmetrics _fontmetrics,boolean _justmeasure) throws Exception{
...
if (true) return _createglyphfromdefaultcolor(_c,_fontmetrics.DefaultColorMetrics /*ng.dsoftlab.stegocam.bctextengine._bcfontmetrics*/ ,_fontmetrics.Clr /*int*/ );
 }else {
...
public ng.dsoftlab.stegocam.bctextengine._bcglyph  _createglyphfromdefaultcolor(String _c,ng.dsoftlab.stegocam.bctextengine._bcfontmetrics _defaultcolormetrics,int _clr) throws Exception{
...
public String  _createline(ng.dsoftlab.stegocam.bctextengine._bcparagraph _p) throws Exception{
...
public ng.dsoftlab.stegocam.bctextengine._bctextrun  _createrun(String _text) throws Exception{
...
_r.TextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/  = _createbctextcharsfromstring(_text);
...
public ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection  _createsinglesection(ng.dsoftlab.stegocam.bctextengine._bctextrun _run,ng.dsoftlab.stegocam.bctextengine._bctextchars _textchars,ng.dsoftlab.stegocam.bctextengine._bcfontmetrics _fontmetrics) throws Exception{
...
_prevgo.SpaceBetweenThisAndNext /*int*/  = _getkernspacebetweenchars(_fontmetrics,_prevchar,_s,_prevgo.Glyph /*ng.dsoftlab.stegocam.bctextengine._bcglyph*/ ,_g);
 }else {
...
public ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle  _createstyle() throws Exception{
...
public boolean  _detectrtl(ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext _un) throws Exception{
String _firstchar = "";
int _cp = 0;
...
public String  _drawline(ng.dsoftlab.stegocam.bctextengine._bctextline _line,int _offsety) throws Exception{
ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext _un = null;
...
public String  _drawparagraph(ng.dsoftlab.stegocam.bctextengine._bcparagraph _paragraph) throws Exception{
ng.dsoftlab.stegocam.bctextengine._bctextline _line = null;
...
public String  _drawsingleline(ng.dsoftlab.stegocam.bctextengine._bctextline _line,anywheresoftware.b4a.objects.B4XViewWrapper _iv,ng.dsoftlab.stegocam.bctextengine._bcparagraph _par) throws Exception{
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public b4a.example.bitmapcreator  _drawsinglelineasync(ng.dsoftlab.stegocam.bctextengine._bctextline _line,anywheresoftware.b4a.objects.B4XViewWrapper _iv,ng.dsoftlab.stegocam.bctextengine._bcparagraph _par,Object _target) throws Exception{
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public anywheresoftware.b4a.objects.B4XCanvas.B4XRect  _drawsinglelineshared(ng.dsoftlab.stegocam.bctextengine._bctextline _line,anywheresoftware.b4a.objects.B4XViewWrapper _iv,ng.dsoftlab.stegocam.bctextengine._bcparagraph _par) throws Exception{
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public String  _drawsinglestylesection(ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection _single,int _offsety) throws Exception{
int _offsetx = 0;
boolean _rtl = false;
ng.dsoftlab.stegocam.bctextengine._bcglyphandoffset _go = null;
ng.dsoftlab.stegocam.bctextengine._bcglyph _g = null;
...
_dt = _asyncbc._createdrawtask((Object)(_g.cbc /*b4a.example.bitmapcreator._compressedbc*/ ),_g.cbc /*b4a.example.bitmapcreator._compressedbc*/ .TargetRect,_x,(int) (_offsety-_g.baseline /*int*/ +_single.Run /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ .VerticalOffset /*int*/ *_mscale),__c.True);
...
_foregroundbc._drawcompressedbitmap(_g.cbc /*b4a.example.bitmapcreator._compressedbc*/ ,_g.cbc /*b4a.example.bitmapcreator._compressedbc*/ .TargetRect,_x,(int) (_offsety-_g.baseline /*int*/ +_single.Run /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ .VerticalOffset /*int*/ *_mscale));
 };
 };
...
_u = _getunderlinestyle(_single.Run /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ );
...
_resizeimageview(_foregroundbc,_par,_foregroundimageview,_par.Style /*ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle*/ .ResizeHeightAutomatically /*boolean*/ );
 };
...
public String  _drawunbreakable(ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext _un,int _offsety) throws Exception{
ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection _single = null;
...
public ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection  _findsinglestylesection(ng.dsoftlab.stegocam.bctextengine._bcparagraph _paragraph,int _x,int _y) throws Exception{
ng.dsoftlab.stegocam.bctextengine._bctextline _line = null;
ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext _un = null;
...
public ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection  _getfirstsinglestyle(ng.dsoftlab.stegocam.bctextengine._bctextline _line) throws Exception{
...
public ng.dsoftlab.stegocam.bctextengine._bcfontmetrics  _getfontmetrics(anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont _fnt,int _clr) throws Exception{
String _key = "";
...
if (true) return (ng.dsoftlab.stegocam.bctextengine._bcfontmetrics)(_fontmetricscache.Get((Object)(_key)));};
...
_fm.DefaultColorMetrics /*ng.dsoftlab.stegocam.bctextengine._bcfontmetrics*/  = _getfontmetrics(_fnt,_defaultcolor);
...
public int  _getkernspacebetweenchars(ng.dsoftlab.stegocam.bctextengine._bcfontmetrics _fm,String _prevchar,String _thischar,ng.dsoftlab.stegocam.bctextengine._bcglyph _prevglyph,ng.dsoftlab.stegocam.bctextengine._bcglyph _thisglyph) throws Exception{
String _together = "";
int _space = 0;
int _res = 0;
int _w = 0;
...
public ng.dsoftlab.stegocam.bctextengine._bcstyledunderline  _getunderlinestyle(ng.dsoftlab.stegocam.bctextengine._bctextrun _run) throws Exception{
...
if (true) return (ng.dsoftlab.stegocam.bctextengine._bcstyledunderline)(_run.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .GetDefault((Object)(_extra_styledunderline),(Object)(_defaultunderlinestyle)));
 //BA.debugLineNum = 739;BA.debugLine="End Sub";
return null;
}
public String  _handleconnectedtextruns(ng.dsoftlab.stegocam.bctextengine._bctextrun _run,anywheresoftware.b4a.objects.collections.List _unbreakables,ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle _style) throws Exception{
...
_cr = (ng.dsoftlab.stegocam.bctextengine._bcconnectedruns)(_run.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_extra_connectedruns)));
...
_mergeunbreakables(_u,(ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext)(_children.Get(_i)));
 }
};
...
public String  _handletextrun(ng.dsoftlab.stegocam.bctextengine._bctextrun _run,anywheresoftware.b4a.objects.collections.List _unbreakables,ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle _style) throws Exception{
ng.dsoftlab.stegocam.bctextengine._bcfontmetrics _fm = null;
int _i1 = 0;
int _i = 0;
String _c = "";
...
_unbreakables.Add((Object)(_createunbreakable(_run,_textcharssubstring(_run.TextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ ,_i1,(int) (_i+_offset)),_fm,__c.True,_style)));
 };
...
_unbreakables.Add((Object)(_createunbreakable(_run,_textcharssubstring(_run.TextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ ,_i,(int) (_i+1)),_fm,__c.True,_style)));
 }else {
...
_unbreakables.Add((Object)(_createunbreakable(_run,_textcharssubstring(_run.TextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ ,_i1,_run.TextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ .Length /*int*/ ),_fm,__c.False,_style)));};
...
_tagparser._initialize /*String*/ (ba,(ng.dsoftlab.stegocam.bctextengine)(this));
...
public boolean  _isspace(ng.dsoftlab.stegocam.bctextengine._bctextchars _tc) throws Exception{
...
public boolean  _isunseparator(ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext _un) throws Exception{
...
if (true) return _wordboundaries.contains(_un.NotFullTextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ .Buffer /*String[]*/ [_un.NotFullTextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ .StartIndex /*int*/ ]);
...
public String  _loaddata(ng.dsoftlab.stegocam.b4xset _set,String _filename) throws Exception{
String _line = "";
int _i = 0;
int _a = 0;
...
public String  _mergeunbreakables(ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext _un1,ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext _un2) throws Exception{
ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection _single = null;
...
public String  _organizelines(ng.dsoftlab.stegocam.bctextengine._bcparagraph _p) throws Exception{
...
_line.Height /*int*/  = (int) (__c.Max(_line.MaxHeightAboveBaseLine /*int*/ +_prevlinebelowbaselineheight+_mmingapbetweenlines*_mscale,_mspacebetweenlines*_p.Style /*ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle*/ .LineSpacingFactor /*float*/ ));
 };
...
_line.StartX /*int*/  = (int) (_indentwidth*_linestyle.Run /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ .IndentLevel /*int*/ );
...
if (_isspace(_last.NotFullTextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ )) { 
...
public String  _organizertlparagraph(ng.dsoftlab.stegocam.bctextengine._bcparagraph _par) throws Exception{
...
public String  _organizesinglestyles(ng.dsoftlab.stegocam.bctextengine._bcparagraph _p) throws Exception{
ng.dsoftlab.stegocam.bctextengine._bctextline _line = null;
ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext _un = null;
int _x = 0;
ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection _single = null;
...
_v.setTop((int) (_line.BaselineY /*int*/ /(double)_mscale-_v.getHeight()+_single.Run /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ .VerticalOffset /*int*/ ));
...
public String  _organizeunbreakables(ng.dsoftlab.stegocam.bctextengine._bcparagraph _p,anywheresoftware.b4a.objects.collections.List _unbreakables) throws Exception{
ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext _un = null;
int _i = 0;
...
if (_textcharequals(_un.NotFullTextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ ,BA.ObjectToString(__c.Chr((int) (13))))) { 
if (true) continue;};
 //BA.debugLineNum = 522;BA.debugLine="If TextCharEquals(un.NotFullTextChars, Chr(10))";
if (_textcharequals(_un.NotFullTextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ ,BA.ObjectToString(__c.Chr((int) (10))))) { 
...
_indent = (int) (_indentwidth*_singlestyle.Run /*ng.dsoftlab.stegocam.bctextengine._bctextrun*/ .IndentLevel /*int*/ );
 //BA.debugLineNum = 529;BA.debugLine="If p.CurrentLine.Width + mSpaceBetweenCharacter";
if (_p.CurrentLine /*ng.dsoftlab.stegocam.bctextengine._bctextline*/ .Width /*int*/ +_mspacebetweencharacters+_un.Width /*int*/ +_indent>(_p.Style /*ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle*/ .MaxWidth /*int*/ -_p.Style /*ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getLeft()-_p.Style /*ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getRight())*_mscale) { 
...
if (_isspace(_un.NotFullTextChars /*ng.dsoftlab.stegocam.bctextengine._bctextchars*/ ) && _p.CurrentLine /*ng.dsoftlab.stegocam.bctextengine._bctextline*/ .Unbreakables /*anywheresoftware.b4a.objects.collections.List*/ .getSize()==1) { 
...
_p.CurrentLine /*ng.dsoftlab.stegocam.bctextengine._bctextline*/ .Width /*int*/  = (int) (_p.CurrentLine /*ng.dsoftlab.stegocam.bctextengine._bctextline*/ .Width /*int*/ +_mspacebetweencharacters);};
...
public ng.dsoftlab.stegocam.bctextengine._bcparagraph  _prepare(anywheresoftware.b4a.objects.collections.List _runs,ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle _style) throws Exception{
ng.dsoftlab.stegocam.bctextengine._bcparagraph _par = null;
...
public ng.dsoftlab.stegocam.bctextengine._bcparagraph  _prepareforlazydrawing(anywheresoftware.b4a.objects.collections.List _runs,ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle _style,anywheresoftware.b4a.objects.B4XViewWrapper _sv) throws Exception{
ng.dsoftlab.stegocam.bctextengine._bcparagraph _par = null;
int _maxheight = 0;
ng.dsoftlab.stegocam.bctextengine._bctextline _line = null;
...
public String  _printtextchars(ng.dsoftlab.stegocam.bctextengine._bctextchars _tc) throws Exception{
...
__c.LogImpl("935717126",_sb.ToString(),0);
...
public String  _resizeimageview(b4a.example.bitmapcreator _bc,ng.dsoftlab.stegocam.bctextengine._bcparagraph _par,anywheresoftware.b4a.objects.B4XViewWrapper _iv,boolean _resizeheight) throws Exception{
anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper _bmp = null;
int _ivheight = 0;
...
public boolean  _textcharequals(ng.dsoftlab.stegocam.bctextengine._bctextchars _tc,String _s) throws Exception{
int _i = 0;
...
public ng.dsoftlab.stegocam.bctextengine._bctextchars  _textcharssubstring(ng.dsoftlab.stegocam.bctextengine._bctextchars _tc,int _startindex,int _endindex) throws Exception{
