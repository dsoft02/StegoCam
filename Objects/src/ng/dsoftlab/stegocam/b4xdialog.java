...
public class b4xdialog extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ng.dsoftlab.stegocam.b4xdialog");
            if (htSubs == null) {
...
__c.LogImpl("942663972","Time: "+BA.NumberToString((__c.DateTime.getNow()-_n)),0);
...
public ResumableSub_Show(ng.dsoftlab.stegocam.b4xdialog parent,Object _text,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
this._text = _text;
this._yes = _yes;
this._no = _no;
...
public ResumableSub_ShowCustom(ng.dsoftlab.stegocam.b4xdialog parent,anywheresoftware.b4a.objects.B4XViewWrapper _content,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
...
public ResumableSub_ShowTemplate(ng.dsoftlab.stegocam.b4xdialog parent,Object _dialogtemplate,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
