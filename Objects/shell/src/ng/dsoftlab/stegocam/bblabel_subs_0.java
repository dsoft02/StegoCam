...
try {
		Debug.PushSubsStack("Base_Resize (bblabel) ","bblabel",32,__ref.getField(false, "ba"),__ref,51);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bblabel.class, "_parseanddraw" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 57;BA.debugLine="Redraw";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bblabel.class, "_redraw" /*RemoteObject*/ );
 };
 };
...
bblabel._style = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle");__ref.setField("_style",bblabel._style);
 //BA.debugLineNum = 8;BA.debugLine="Private mTextEngine As BCTextEngine";
bblabel._mtextengine = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine");__ref.setField("_mtextengine",bblabel._mtextengine);
...
bblabel._paragraph = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcparagraph");__ref.setField("_paragraph",bblabel._paragraph);
...
bblabel._parsedata = RemoteObject.createNew ("ng.dsoftlab.stegocam.bbcodeparser._bbcodeparsedata");__ref.setField("_parsedata",bblabel._parsedata);
...
try {
		Debug.PushSubsStack("DesignerCreateView (bblabel) ","bblabel",32,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("getText (bblabel) ","bblabel",32,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("getTextEngine (bblabel) ","bblabel",32,__ref.getField(false, "ba"),__ref,72);
...
try {
		Debug.PushSubsStack("Initialize (bblabel) ","bblabel",32,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("ParseAndDraw (bblabel) ","bblabel",32,__ref.getField(false, "ba"),__ref,85);
...
try {
		Debug.PushSubsStack("Redraw (bblabel) ","bblabel",32,__ref.getField(false, "ba"),__ref,98);
...
Debug.JustUpdateDeviceLine();
bblabel._style = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createstyle" /*RemoteObject*/ );__ref.setField("_style",bblabel._style);
...
try {
		Debug.PushSubsStack("setText (bblabel) ","bblabel",32,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("setTextEngine (bblabel) ","bblabel",32,__ref.getField(false, "ba"),__ref,62);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bblabel.class, "_settext" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
 };
