...
try {
		Debug.PushSubsStack("Append (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,24);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_append2" /*RemoteObject*/ ,(Object)(_data),(Object)(BA.numberCast(int.class, 0)),(Object)(_data.getField(true,"length")));
...
try {
		Debug.PushSubsStack("Append2 (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,31);
...
Debug.JustUpdateDeviceLine();
_oldlength = __ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),_length}, "+",1, 1)));Debug.locals.put("OldLength", _oldlength);Debug.locals.put("OldLength", _oldlength);
...
try {
		Debug.PushSubsStack("ChangeLength (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,12);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _oldlength;
...
try {
		Debug.PushSubsStack("Clear (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,37);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("getBuffer (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,103);
...
try {
		Debug.PushSubsStack("getInternalBuffer (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,127);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_mbuffer" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("getLength (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,92);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(true,"_mlength" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("IndexOf (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,107);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_indexof2" /*RemoteObject*/ ,(Object)(_searchfor),(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("IndexOf2 (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,112);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(int.class, _i1);
 };
 }
}Debug.locals.put("i1", _i1);
;
...
try {
		Debug.PushSubsStack("Initialize (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,6);
...
try {
		Debug.PushSubsStack("Insert (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,43);
...
b4xbytesbuilder.__c.runVoidMethod ("LogImpl","91114114",RemoteObject.createImmutable("Index too large"),0);};
 BA.debugLineNum = 46;BA.debugLine="Append(Data)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_append" /*RemoteObject*/ ,(Object)(_data));
 }else {
 BA.debugLineNum = 48;BA.debugLine="Dim AfterIndex() As Byte = SubArray(Index)";
Debug.JustUpdateDeviceLine();
_afterindex = __ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_subarray" /*RemoteObject*/ ,(Object)(_index));Debug.locals.put("AfterIndex", _afterindex);Debug.locals.put("AfterIndex", _afterindex);
 BA.debugLineNum = 49;BA.debugLine="ChangeLength(mLength + Data.Length)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),_data.getField(true,"length")}, "+",1, 1)));
...
try {
		Debug.PushSubsStack("Remove (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,69);
...
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_subarray2" /*RemoteObject*/ ,(Object)(_beginindex),(Object)(_endindex));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
Debug.JustUpdateDeviceLine();
_afterendindex = __ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_subarray" /*RemoteObject*/ ,(Object)(_endindex));Debug.locals.put("AfterEndIndex", _afterendindex);Debug.locals.put("AfterEndIndex", _afterendindex);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),(RemoteObject.solve(new RemoteObject[] {_endindex,_beginindex}, "-",1, 1))}, "-",1, 1)));
...
try {
		Debug.PushSubsStack("Set (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,56);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_index,BA.numberCast(double.class, __ref.getField(true,"_mlength" /*RemoteObject*/ )))) { 
b4xbytesbuilder.__c.runVoidMethod ("LogImpl","91179650",RemoteObject.createImmutable("Index too large"),0);};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {_data.getField(true,"length"),_index}, "+",1, 1)));
 };
...
try {
		Debug.PushSubsStack("SubArray (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,80);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_subarray2" /*RemoteObject*/ ,(Object)(_beginindex),(Object)(__ref.getField(true,"_mlength" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("SubArray2 (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("ToArray (b4xbytesbuilder) ","b4xbytesbuilder",18,__ref.getField(false, "ba"),__ref,97);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (ng.dsoftlab.stegocam.b4xbytesbuilder.class, "_subarray" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
