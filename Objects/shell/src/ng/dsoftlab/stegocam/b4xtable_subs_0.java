...
try {
		Debug.PushSubsStack("AddColumn (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,592);
if (RapidSub.canDelegate("addcolumn")) { return __ref.runUserSub(false, "b4xtable","addcolumn", __ref, _title, _columntype);}
RemoteObject _c = RemoteObject.declareNull("ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn");
...
Debug.JustUpdateDeviceLine();
_c = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xtable._b4xtablecolumn");Debug.locals.put("c", _c);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_createcolumnlayouts" /*RemoteObject*/ ,(Object)(_c),(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1)));
...
_header = __ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_getlabelfromcolumn" /*RemoteObject*/ ,(Object)(_c),(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("header", _header);Debug.locals.put("header", _header);
 BA.debugLineNum = 608;BA.debugLine="SetTextOrCSBuilderToLabel (header, Title)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_settextorcsbuildertolabel" /*RemoteObject*/ ,(Object)(_header),(Object)((_title)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_addcolumntoclv" /*RemoteObject*/ ,(Object)(_c));
 };
...
try {
		Debug.PushSubsStack("AddColumnToCLV (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,584);
...
try {
		Debug.PushSubsStack("Base_Resize (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,141);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"False")),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("BuildLayoutsCache (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,616);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_createcolumnlayouts" /*RemoteObject*/ ,(Object)(_c),(Object)(RemoteObject.solve(new RemoteObject[] {_size,RemoteObject.createImmutable(1)}, "+",1, 1)));
 }
}Debug.locals.put("c", _c);
;
...
try {
		Debug.PushSubsStack("BuildQuery (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,338);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createNewArray("Object",new int[] {3},new Object[] {(_sb.runMethod(true,"ToString")),(_aargs),(_totalcount)});
...
try {
		Debug.PushSubsStack("CalculateWidths (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,562);
...
try {
		Debug.PushSubsStack("Cell_Click (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,735);
...
try {
		Debug.PushSubsStack("Cell_LongClick (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,739);
...
try {
		Debug.PushSubsStack("CellClicked (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,780);
...
public ResumableSub_CellClicked(ng.dsoftlab.stegocam.b4xtable parent,RemoteObject __ref,RemoteObject _pnl,RemoteObject _longclicked) {
this.parent = parent;
this.__ref = __ref;
this._pnl = _pnl;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_headerclicked" /*RemoteObject*/ ,(Object)(_column));
 if (true) break;
;
...
try {
		Debug.PushSubsStack("CheckAndRemoveColumnThatWasAddedToIncorrectParent (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,280);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_removecolumnfromclv" /*RemoteObject*/ ,(Object)(_c));
 }else {
...
b4xtable._defaultformatter = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xformatter");__ref.setField("_defaultformatter",b4xtable._defaultformatter);
b4xtable._defaultdataformatter = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xformatter");__ref.setField("_defaultdataformatter",b4xtable._defaultdataformatter);
...
b4xtable._searchfield = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xfloattextfield");__ref.setField("_searchfield",b4xtable._searchfield);
...
try {
		Debug.PushSubsStack("Clear (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,146);
...
public ResumableSub_Clear(ng.dsoftlab.stegocam.b4xtable parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
java.util.LinkedHashMap<String, Object> rsLocals = new java.util.LinkedHashMap<String, Object>();
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_clearnavigationstate" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","958130452",RemoteObject.createImmutable("closing old db."),0);
...
try {
		Debug.PushSubsStack("ClearDataView (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,401);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("ClearNavigationState (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,172);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblnext" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
 BA.debugLineNum = 175;BA.debugLine="SetPageLabelState(lblLast, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbllast" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
 BA.debugLineNum = 176;BA.debugLine="SetPageLabelState(lblBack, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblback" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
 BA.debugLineNum = 177;BA.debugLine="SetPageLabelState(lblFirst, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblfirst" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("ColumnToSQLType (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,708);
...
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToString("TEXT");}
else {
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToString("INTEGER");};
...
try {
		Debug.PushSubsStack("CreateCellViews (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,713);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setmousetransparent" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _lbl.getObject()));
...
try {
		Debug.PushSubsStack("CreateColumnLayouts (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,622);
...
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = __ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_createcellviews" /*RemoteObject*/ );Debug.locals.put("p", _p);Debug.locals.put("p", _p);
...
try {
		Debug.PushSubsStack("CreateDataView (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,392);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("CreateTable (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,692);
...
Debug.JustUpdateDeviceLine();
_sb.runVoidMethod ("Append",(Object)(RemoteObject.concat(_column.getField(true,"SQLID" /*RemoteObject*/ ),RemoteObject.createImmutable(" "),__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_columntosqltype" /*RemoteObject*/ ,(Object)(_column)),RemoteObject.createImmutable(","))));
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,104);
...
public ResumableSub_DesignerCreateView(ng.dsoftlab.stegocam.b4xtable parent,RemoteObject __ref,RemoteObject _base,RemoteObject _lbl,RemoteObject _props) {
this.parent = parent;
this.__ref = __ref;
this._base = _base;
this._lbl = _lbl;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xfloattextfield.class, "_update" /*RemoteObject*/ );
 BA.debugLineNum = 126;BA.debugLine="Dim jo As JavaObject = SearchField.TextField";
Debug.JustUpdateDeviceLine();
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 127;BA.debugLine="jo.RunMethod(\"setImeOptions\", Array(Bit.Or(6, 0x1";
Debug.JustUpdateDeviceLine();
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setImeOptions")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(parent.__c.getField(false,"Bit").runMethod(true,"Or",(Object)(BA.numberCast(int.class, 6)),(Object)(BA.numberCast(int.class, ((int)0x10000000)))))})));
 BA.debugLineNum = 132;BA.debugLine="SetMouseTransparent(lblSort)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setmousetransparent" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblsort" /*RemoteObject*/ )));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(parent.__c.getField(true,"True")),(Object)(parent.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("GetColumn (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,540);
...
try {
		Debug.PushSubsStack("getCurrentPage (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,899);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(true,"_mcurrentpage" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("getFirstRowIndex (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,889);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("GetLabelFromColumn (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,557);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _p.runMethod(false,"GetView",(Object)(_c.getField(true,"LabelIndex" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("GetRow (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,862);
...
try {
		Debug.PushSubsStack("getRowsPerPage (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,894);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(true,"_mrowsperpage" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("getSize (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,962);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(true,"_countall" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("HeaderClicked (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,828);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_updatesorticon" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("ImplUpdateDataFromQuery (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,414);
...
public ResumableSub_ImplUpdateDataFromQuery(ng.dsoftlab.stegocam.b4xtable parent,RemoteObject __ref,RemoteObject _query,RemoteObject _args,RemoteObject _totalcount,RemoteObject _dontsleep) {
this.parent = parent;
this.__ref = __ref;
this._query = _query;
this._args = _args;
...
Debug.JustUpdateDeviceLine();
_rs = RemoteObject.createNew ("anywheresoftware.b4a.sql.SQL.ResultSetWrapper");
_rs = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery2",(Object)(_query),(Object)((_args))));Debug.locals.put("rs", _rs);Debug.locals.put("rs", _rs);
...
Debug.JustUpdateDeviceLine();
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_lbl = __ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_getlabelfromcolumn" /*RemoteObject*/ ,(Object)(_c),(Object)(_rownumber));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_settexttocell" /*RemoteObject*/ ,(Object)(_rs.runMethod(true,"GetString",(Object)(_c.getField(true,"SQLID" /*RemoteObject*/ )))),(Object)(_lbl),(Object)(_c.getField(true,"Searchable" /*RemoteObject*/ )));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
_c.getField(false,"Formatter" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xformatter.class, "_formatlabel" /*RemoteObject*/ ,(Object)(_rs.runMethod(true,"GetDouble",(Object)(_c.getField(true,"SQLID" /*RemoteObject*/ )))),(Object)(_lbl));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_getlabelfromcolumn" /*RemoteObject*/ ,(Object)(_c),(Object)(BA.numberCast(int.class, _i))).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 if (true) break;
if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbllast" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("g",_totalcount,BA.numberCast(double.class, 0)))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblnext" /*RemoteObject*/ )),(Object)(_aretheremoreresults));
 BA.debugLineNum = 475;BA.debugLine="SetPageLabelState(lblLast, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbllast" /*RemoteObject*/ )),(Object)(parent.__c.getField(true,"False")));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblback" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean(">",__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),BA.numberCast(double.class, 0)))));
 BA.debugLineNum = 478;BA.debugLine="SetPageLabelState(lblFirst, lblBack.Tag)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblfirst" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(__ref.getField(false,"_lblback" /*RemoteObject*/ ).runMethod(false,"getTag"))));
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","959113542",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
;
...
try {
		Debug.PushSubsStack("Initialize (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,81);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_defaultformatter" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xformatter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 86;BA.debugLine="DefaultDataFormatter.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_defaultdataformatter" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xformatter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
try {
		Debug.PushSubsStack("lbl_Click (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,725);
...
Debug.JustUpdateDeviceLine();
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_lbl = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), b4xtable.__c.runMethod(false,"Sender",__ref.getField(false, "ba")));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 727;BA.debugLine="CellClicked(lbl.Parent, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_cellclicked" /*void*/ ,(Object)(_lbl.runMethod(false,"getParent")),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("lbl_LongClick (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,730);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_cellclicked" /*void*/ ,(Object)(_lbl.runMethod(false,"getParent")),(Object)(b4xtable.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("lblBack_Click (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,912);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "-",1, 1)));
...
try {
		Debug.PushSubsStack("lblFirst_Click (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,907);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("lblLast_Click (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,917);
if (RapidSub.canDelegate("lbllast_click")) { return __ref.runUserSub(false, "b4xtable","lbllast_click", __ref);}
RemoteObject _numberofpages = RemoteObject.createImmutable(0);
...
Debug.JustUpdateDeviceLine();
_numberofpages = BA.numberCast(int.class, b4xtable.__c.runMethod(true,"Ceil",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mcurrentcount" /*RemoteObject*/ ),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "/",0, 0))));Debug.locals.put("NumberOfPages", _numberofpages);Debug.locals.put("NumberOfPages", _numberofpages);
 BA.debugLineNum = 920;BA.debugLine="setFirstRowIndex ((NumberOfPages - 1) * mRowsPerP";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_numberofpages,RemoteObject.createImmutable(1)}, "-",1, 1)),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "*",0, 1)));
...
try {
		Debug.PushSubsStack("lblNext_Click (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,923);
...
try {
		Debug.PushSubsStack("Refresh (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,183);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("Refresh2 (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,192);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_calculatewidths" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_checkandremovecolumnthatwasaddedtoincorrectparent" /*RemoteObject*/ ,(Object)(_c),(Object)(_isfrozen));
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_resizecolumnimpl" /*RemoteObject*/ ,(Object)(_c),(Object)(_totalheight));
...
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(_dontsleep));};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_resizeandreorderclvitems" /*RemoteObject*/ );
 BA.debugLineNum = 254;BA.debugLine="UpdateSearchFieldVisibility";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_updatesearchfieldvisibility" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("RefreshNow (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,188);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")),(Object)(b4xtable.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("RemoveColumnFromCLV (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,290);
...
try {
		Debug.PushSubsStack("ResizeAndReorderCLVItems (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,258);
...
try {
		Debug.PushSubsStack("ResizeColumnImpl (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,300);
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,947);
...
public ResumableSub_SearchField_TextChanged(ng.dsoftlab.stegocam.b4xtable parent,RemoteObject __ref,RemoteObject _old,RemoteObject _new) {
this.parent = parent;
this.__ref = __ref;
this._old = _old;
this._new = _new;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(parent.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("setCurrentPage (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,903);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_p,RemoteObject.createImmutable(1)}, "-",1, 1)),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "*",0, 1)));
...
try {
		Debug.PushSubsStack("SetData (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,654);
...
public ResumableSub_SetData(ng.dsoftlab.stegocam.b4xtable parent,RemoteObject __ref,RemoteObject _data) {
this.parent = parent;
this.__ref = __ref;
this._data = _data;
}
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_createtable" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_refreshnow" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("setFirstRowIndex (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,883);
...
try {
		Debug.PushSubsStack("SetMouseTransparent (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,757);
...
try {
		Debug.PushSubsStack("SetPageLabelState (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,547);
...
try {
		Debug.PushSubsStack("SetTextOrCSBuilderToLabel (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,764);
...
try {
		Debug.PushSubsStack("SetTextToCell (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,491);
...
try {
		Debug.PushSubsStack("UpdateData (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,329);
...
Debug.JustUpdateDeviceLine();
_o = __ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_buildquery" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")));Debug.locals.put("o", _o);Debug.locals.put("o", _o);
 BA.debugLineNum = 333;BA.debugLine="ImplUpdateDataFromQuery (o(0), o(1), o(2), DontSl";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xtable.class, "_implupdatedatafromquery" /*void*/ ,(Object)(BA.ObjectToString(_o.getArrayElement(false,BA.numberCast(int.class, 0)))),(Object)(_o.getArrayElement(false,BA.numberCast(int.class, 1))),(Object)(BA.numberCast(int.class, _o.getArrayElement(false,BA.numberCast(int.class, 2)))),(Object)(_dontsleep));
...
try {
		Debug.PushSubsStack("UpdateSearchFieldVisibility (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,273);
...
try {
		Debug.PushSubsStack("UpdateSortIcon (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,843);
...
__ref.getField(false,"_lblsort" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(b4xtable.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xf0de))))));}
else {
__ref.getField(false,"_lblsort" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(b4xtable.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xf0dd))))));};
...
try {
		Debug.PushSubsStack("UpdateTableCounters (b4xtable) ","b4xtable",25,__ref.getField(false, "ba"),__ref,409);
