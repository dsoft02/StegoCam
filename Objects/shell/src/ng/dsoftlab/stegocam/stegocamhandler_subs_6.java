...
public class stegocamhandler_subs_6 {
...
try {
		Debug.PushSubsStack("BytesToFile (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,208);
...
Debug.locals.put("Data", _data);
 BA.debugLineNum = 208;BA.debugLine="Sub BytesToFile (Dir As String, FileName As String";
Debug.ShouldStop(32768);
 BA.debugLineNum = 209;BA.debugLine="Dim out As OutputStream = File.OpenOutput(Dir, Fi";
...
try {
		Debug.PushSubsStack("CombineBytes (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,151);
...
Debug.locals.put("arr2", _arr2);
 BA.debugLineNum = 151;BA.debugLine="Sub CombineBytes(arr1() As Byte, arr2() As Byte) A";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 152;BA.debugLine="Dim res(arr1.Length + arr2.Length) As Byte";
...
_res = RemoteObject.createNewArray ("byte", new int[] {RemoteObject.solve(new RemoteObject[] {_arr1.getField(true,"length"),_arr2.getField(true,"length")}, "+",1, 1).<Integer>get().intValue()}, new Object[]{});Debug.locals.put("res", _res);
 BA.debugLineNum = 153;BA.debugLine="Dim bc As ByteConverter 'ByteConverter library";
Debug.ShouldStop(16777216);
_bc = RemoteObject.createNew ("anywheresoftware.b4a.agraham.byteconverter.ByteConverter");Debug.locals.put("bc", _bc);
 BA.debugLineNum = 154;BA.debugLine="bc.ArrayCopy(arr1, 0, res, 0, arr1.Length)";
...
_bc.runVoidMethod ("ArrayCopy",(Object)((_arr1)),(Object)(BA.numberCast(int.class, 0)),(Object)((_res)),(Object)(BA.numberCast(int.class, 0)),(Object)(_arr1.getField(true,"length")));
 BA.debugLineNum = 155;BA.debugLine="bc.ArrayCopy(arr2, 0, res, arr1.Length, arr2.Leng";
...
try {
		Debug.PushSubsStack("copyFiletoTemp (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,102);
...
Debug.locals.put("cfilename", _cfilename);
 BA.debugLineNum = 102;BA.debugLine="Sub copyFiletoTemp(cfilename As String)";
Debug.ShouldStop(32);
 BA.debugLineNum = 103;BA.debugLine="Try";
Debug.ShouldStop(64);
try { BA.debugLineNum = 104;BA.debugLine="Msgbox(cfilename,\"cfile\")";
...
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("jo", _jo);
 BA.debugLineNum = 106;BA.debugLine="Dim Inp As InputStream  = GetStreamFromContentRe";
...
_inp = __ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_getstreamfromcontentresult" /*RemoteObject*/ ,(Object)(_cfilename));Debug.locals.put("Inp", _inp);Debug.locals.put("Inp", _inp);
 BA.debugLineNum = 107;BA.debugLine="Dim ofilename As String = \"stegofile.\" & file_ex";
...
_ofilename = RemoteObject.concat(RemoteObject.createImmutable("stegofile."),__ref.getField(true,"_file_extension" /*RemoteObject*/ ));Debug.locals.put("ofilename", _ofilename);Debug.locals.put("ofilename", _ofilename);
 BA.debugLineNum = 108;BA.debugLine="Dim Out As OutputStream = File.OpenOutput(File.D";
...
stegocamhandler.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence(stegocamhandler.__c.getField(false,"File").runMethod(true,"Exists",(Object)(stegocamhandler.__c.getField(false,"File").runMethod(true,"getDirInternalCache")),(Object)(_cfilename)))),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("exist"))),__ref.runMethod(false,"getActivityBA"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e12.toString()); BA.debugLineNum = 114;BA.debugLine="Msgbox(LastException.Message,\"\")";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("createTempCoverImage (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,171);
...
Debug.locals.put("img", _img);
 BA.debugLineNum = 171;BA.debugLine="Sub createTempCoverImage(img As ImageView)";
Debug.ShouldStop(1024);
 BA.debugLineNum = 173;BA.debugLine="Dim Bitmap1 As Bitmap = img.Bitmap";
Debug.ShouldStop(4096);
...
_out = RemoteObject.createNew ("anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper");Debug.locals.put("Out", _out);
 BA.debugLineNum = 176;BA.debugLine="Out = File.OpenOutput(File.DirInternalCache, \"st";
Debug.ShouldStop(32768);
_out = stegocamhandler.__c.getField(false,"File").runMethod(false,"OpenOutput",(Object)(stegocamhandler.__c.getField(false,"File").runMethod(true,"getDirInternalCache")),(Object)(BA.ObjectToString("stegocover.png")),(Object)(stegocamhandler.__c.getField(true,"False")));Debug.locals.put("Out", _out);
 BA.debugLineNum = 177;BA.debugLine="Bitmap1.WriteToStream(Out, 100, \"PNG\")";
Debug.ShouldStop(65536);
_bitmap1.runVoidMethod ("WriteToStream",(Object)((_out.getObject())),(Object)(BA.numberCast(int.class, 100)),(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.Bitmap.CompressFormat"),RemoteObject.createImmutable("PNG"))));
 BA.debugLineNum = 178;BA.debugLine="Out.Close";
Debug.ShouldStop(131072);
_out.runVoidMethod ("Close");
...
try {
		Debug.PushSubsStack("deleteTempResources (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,202);
...
Debug.locals.put("res", _res);
 BA.debugLineNum = 202;BA.debugLine="Sub deleteTempResources(res As String)";
Debug.ShouldStop(512);
 BA.debugLineNum = 203;BA.debugLine="If res =\"stegocover\" Then";
Debug.ShouldStop(1024);
if (RemoteObject.solveBoolean("=",_res,BA.ObjectToString("stegocover"))) { 
 BA.debugLineNum = 204;BA.debugLine="File.Delete(File.DirInternalCache, \"stegocover.p";
Debug.ShouldStop(2048);
...
__ref.setField ("_embeddingsuccessful" /*RemoteObject*/ ,stegocamhandler.__c.getField(true,"False"));
 BA.debugLineNum = 66;BA.debugLine="Msgbox(file_extension,\"extension\")";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("ExtractTextWithPassword (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,161);
...
Debug.locals.put("password", _password);
 BA.debugLineNum = 161;BA.debugLine="Public Sub ExtractTextWithPassword(imageFilePath A";
Debug.ShouldStop(1);
 BA.debugLineNum = 163;BA.debugLine="steg.ExtractToString2(imageFilePath, password, \"s";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("file_Embedded (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,119);
...
Debug.locals.put("OutFileName", _outfilename);
 BA.debugLineNum = 119;BA.debugLine="Sub file_Embedded(OutFileName As String)";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 120;BA.debugLine="Try";
Debug.ShouldStop(8388608);
try { BA.debugLineNum = 122;BA.debugLine="Dim imageBytes() As Byte = File.ReadBytes(OutFil";
Debug.ShouldStop(33554432);
_imagebytes = stegocamhandler.__c.getField(false,"File").runMethod(false,"ReadBytes",(Object)(_outfilename),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("imageBytes", _imagebytes);Debug.locals.put("imageBytes", _imagebytes);
 BA.debugLineNum = 124;BA.debugLine="Dim textStr As String = \"FILE_\" & file_extension";
Debug.ShouldStop(134217728);
_textstr = RemoteObject.concat(RemoteObject.createImmutable("FILE_"),__ref.getField(true,"_file_extension" /*RemoteObject*/ ));Debug.locals.put("textStr", _textstr);Debug.locals.put("textStr", _textstr);
 BA.debugLineNum = 127;BA.debugLine="Dim textBytes() As Byte = textStr.GetBytes(\"UTF8";
Debug.ShouldStop(1073741824);
_textbytes = _textstr.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")));Debug.locals.put("textBytes", _textbytes);Debug.locals.put("textBytes", _textbytes);
 BA.debugLineNum = 130;BA.debugLine="Dim modifiedBytes() As Byte =CombineBytes(stegoC";
Debug.ShouldStop(2);
_modifiedbytes = __ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_combinebytes" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_stegocambytes" /*RemoteObject*/ )),(Object)(_textbytes));Debug.locals.put("modifiedBytes", _modifiedbytes);Debug.locals.put("modifiedBytes", _modifiedbytes);
 BA.debugLineNum = 133;BA.debugLine="Dim newImageBytes() As Byte = CombineBytes(image";
Debug.ShouldStop(16);
_newimagebytes = __ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_combinebytes" /*RemoteObject*/ ,(Object)(_imagebytes),(Object)(_modifiedbytes));Debug.locals.put("newImageBytes", _newimagebytes);Debug.locals.put("newImageBytes", _newimagebytes);
 BA.debugLineNum = 136;BA.debugLine="File.WriteBytes(OutFileName,\"\", newImageBytes)";
Debug.ShouldStop(128);
stegocamhandler.__c.getField(false,"File").runVoidMethod ("WriteBytes",(Object)(_outfilename),(Object)(BA.ObjectToString("")),(Object)(_newimagebytes));
 BA.debugLineNum = 139;BA.debugLine="File.Copy(OutFileName,\"\",config.stegoImagePath,c";
Debug.ShouldStop(1024);
stegocamhandler.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(_outfilename),(Object)(BA.ObjectToString("")),(Object)(stegocamhandler._config._stegoimagepath /*RemoteObject*/ ),(Object)(__ref.getField(true,"_curfilename" /*RemoteObject*/ )));
 BA.debugLineNum = 140;BA.debugLine="embeddingSuccessful =File.Exists(config.stegoIma";
Debug.ShouldStop(2048);
__ref.setField ("_embeddingsuccessful" /*RemoteObject*/ ,stegocamhandler.__c.getField(false,"File").runMethod(true,"Exists",(Object)(stegocamhandler._config._stegoimagepath /*RemoteObject*/ ),(Object)(__ref.getField(true,"_curfilename" /*RemoteObject*/ ))));
 BA.debugLineNum = 141;BA.debugLine="lastErrorMessage=\"\"";
Debug.ShouldStop(4096);
__ref.setField ("_lasterrormessage" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 143;BA.debugLine="File.Delete(OutFileName,\"\")";
Debug.ShouldStop(16384);
stegocamhandler.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(_outfilename),(Object)(RemoteObject.createImmutable("")));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e13) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e13.toString()); BA.debugLineNum = 145;BA.debugLine="embeddingSuccessful =False";
Debug.ShouldStop(65536);
__ref.setField ("_embeddingsuccessful" /*RemoteObject*/ ,stegocamhandler.__c.getField(true,"False"));
 BA.debugLineNum = 146;BA.debugLine="lastErrorMessage=\"Embedding Failed: \" & LastExce";
Debug.ShouldStop(131072);
__ref.setField ("_lasterrormessage" /*RemoteObject*/ ,RemoteObject.concat(RemoteObject.createImmutable("Embedding Failed: "),stegocamhandler.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA")).runMethod(true,"getMessage")));
 BA.debugLineNum = 147;BA.debugLine="ToastMessageShow(\"Embedding Failed: \" & LastExce";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("FileToBytes (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,214);
if (RapidSub.canDelegate("filetobytes")) { return __ref.runUserSub(false, "stegocamhandler","filetobytes", __ref, _dir, _filename);}
Debug.locals.put("Dir", _dir);
Debug.locals.put("FileName", _filename);
 BA.debugLineNum = 214;BA.debugLine="Sub FileToBytes (Dir As String, FileName As String";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 215;BA.debugLine="Return Bit.InputStreamToBytes(File.OpenInput(Dir,";
Debug.ShouldStop(4194304);
...
RemoteObject _jo = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
RemoteObject _jo2 = RemoteObject.declareNull("Object");
...
Debug.ShouldStop(134217728);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("jo", _jo);
 BA.debugLineNum = 93;BA.debugLine="jo = jo.InitializeStatic(\"anywheresoftware.b4a.ob";
Debug.ShouldStop(268435456);
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _jo.runMethod(false,"InitializeStatic",(Object)(RemoteObject.createImmutable("anywheresoftware.b4a.objects.streams.File"))).runMethod(false,"GetField",(Object)(RemoteObject.createImmutable("ContentDir"))));Debug.locals.put("jo", _jo);
 BA.debugLineNum = 94;BA.debugLine="Dim jo2 As Object";
Debug.ShouldStop(536870912);
_jo2 = RemoteObject.createNew ("Object");Debug.locals.put("jo2", _jo2);
 BA.debugLineNum = 95;BA.debugLine="jo2 = jo";
Debug.ShouldStop(1073741824);
_jo2 = (_jo.getObject());Debug.locals.put("jo2", _jo2);
 BA.debugLineNum = 96;BA.debugLine="Dim In As InputStream = File.OpenInput(jo2, UriSt";
Debug.ShouldStop(-2147483648);
_in = RemoteObject.createNew ("anywheresoftware.b4a.objects.streams.File.InputStreamWrapper");
_in = stegocamhandler.__c.getField(false,"File").runMethod(false,"OpenInput",(Object)(BA.ObjectToString(_jo2)),(Object)(_uristring));Debug.locals.put("In", _in);Debug.locals.put("In", _in);
 BA.debugLineNum = 99;BA.debugLine="Return iStream";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("isCoverImage (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,196);
if (RapidSub.canDelegate("iscoverimage")) { return __ref.runUserSub(false, "stegocamhandler","iscoverimage", __ref);}
 BA.debugLineNum = 196;BA.debugLine="Sub isCoverImage() As Boolean";
Debug.ShouldStop(8);
 BA.debugLineNum = 197;BA.debugLine="Return File.Exists(File.DirInternalCache, \"stegoc";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("steg_StringExtracted (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,166);
...
Debug.locals.put("SecretMessage", _secretmessage);
 BA.debugLineNum = 166;BA.debugLine="Sub steg_StringExtracted(SecretMessage As String)";
Debug.ShouldStop(32);
 BA.debugLineNum = 167;BA.debugLine="Log(\"Extracted Text: \" & SecretMessage)";
Debug.ShouldStop(64);
