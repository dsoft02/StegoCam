...
public class stegocamhandler_subs_7 {
...
_jo2 = (_jo.getObject());Debug.locals.put("jo2", _jo2);
 BA.debugLineNum = 96;BA.debugLine="iStream = File.OpenInput(jo2, UriString)";
Debug.ShouldStop(-2147483648);
_istream = stegocamhandler.__c.getField(false,"File").runMethod(false,"OpenInput",(Object)(BA.ObjectToString(_jo2)),(Object)(_uristring));Debug.locals.put("iStream", _istream);
