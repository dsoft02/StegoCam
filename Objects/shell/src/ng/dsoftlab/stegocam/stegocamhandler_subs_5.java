...
public class stegocamhandler_subs_5 {
...
try {
		Debug.PushSubsStack("copyFiletoTemp (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,103);
...
Debug.locals.put("cfilename", _cfilename);
 BA.debugLineNum = 103;BA.debugLine="Sub copyFiletoTemp(cfilename As String)";
Debug.ShouldStop(64);
 BA.debugLineNum = 104;BA.debugLine="Try";
Debug.ShouldStop(128);
try { BA.debugLineNum = 105;BA.debugLine="Msgbox(cfilename,\"cfile\")";
...
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("jo", _jo);
 BA.debugLineNum = 107;BA.debugLine="Dim Inp As InputStream  = GetStreamFromContentRe";
...
_inp = __ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_getstreamfromcontentresult" /*RemoteObject*/ ,(Object)(_cfilename));Debug.locals.put("Inp", _inp);Debug.locals.put("Inp", _inp);
 BA.debugLineNum = 108;BA.debugLine="Dim ofilename As String = \"stegofile.\" & file_ex";
...
_ofilename = RemoteObject.concat(RemoteObject.createImmutable("stegofile."),__ref.getField(true,"_file_extension" /*RemoteObject*/ ));Debug.locals.put("ofilename", _ofilename);Debug.locals.put("ofilename", _ofilename);
 BA.debugLineNum = 109;BA.debugLine="Dim Out As OutputStream = File.OpenOutput(File.D";
...
stegocamhandler.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence(stegocamhandler.__c.getField(false,"File").runMethod(true,"Exists",(Object)(stegocamhandler.__c.getField(false,"File").runMethod(true,"getDirInternalCache")),(Object)(_cfilename)))),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("exist"))),__ref.runMethod(false,"getActivityBA"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e12.toString()); BA.debugLineNum = 115;BA.debugLine="Msgbox(LastException.Message,\"\")";
Debug.ShouldStop(262144);
stegocamhandler.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence(stegocamhandler.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA")).runMethod(true,"getMessage"))),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable(""))),__ref.runMethod(false,"getActivityBA"));
 BA.debugLineNum = 116;BA.debugLine="Log(\":: issue \" & LastException)";
Debug.ShouldStop(524288);
...
stegocamhandler.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence(_secretfile)),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("secret file"))),__ref.runMethod(false,"getActivityBA"));
 BA.debugLineNum = 71;BA.debugLine="copyFiletoTemp(SecretFile)";
Debug.ShouldStop(64);
__ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_copyfiletotemp" /*RemoteObject*/ ,(Object)(_secretfile));
 BA.debugLineNum = 73;BA.debugLine="Dim imageFilePath As String  = File.Combine(File";
Debug.ShouldStop(256);
_imagefilepath = stegocamhandler.__c.getField(false,"File").runMethod(true,"Combine",(Object)(stegocamhandler.__c.getField(false,"File").runMethod(true,"getDirInternalCache")),(Object)(RemoteObject.createImmutable("stegocover.png")));Debug.locals.put("imageFilePath", _imagefilepath);Debug.locals.put("imageFilePath", _imagefilepath);
 BA.debugLineNum = 74;BA.debugLine="Dim outputFilePath  As String = File.Combine(Fil";
Debug.ShouldStop(512);
_outputfilepath = stegocamhandler.__c.getField(false,"File").runMethod(true,"Combine",(Object)(stegocamhandler.__c.getField(false,"File").runMethod(true,"getDirInternalCache")),(Object)(__ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_generatefilename" /*RemoteObject*/ )));Debug.locals.put("outputFilePath", _outputfilepath);Debug.locals.put("outputFilePath", _outputfilepath);
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e10.toString()); BA.debugLineNum = 77;BA.debugLine="Msgbox(LastException.Message,\"\")";
Debug.ShouldStop(4096);
stegocamhandler.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence(stegocamhandler.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA")).runMethod(true,"getMessage"))),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable(""))),__ref.runMethod(false,"getActivityBA"));
 };
...
try {
		Debug.PushSubsStack("GetStreamFromContentResult (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,83);
...
Debug.locals.put("UriString", _uristring);
 BA.debugLineNum = 83;BA.debugLine="Sub GetStreamFromContentResult(UriString As String";
Debug.ShouldStop(262144);
 BA.debugLineNum = 84;BA.debugLine="Dim r As Reflector";
Debug.ShouldStop(524288);
_r = RemoteObject.createNew ("anywheresoftware.b4a.agraham.reflection.Reflection");Debug.locals.put("r", _r);
 BA.debugLineNum = 85;BA.debugLine="Dim Uri As Object";
Debug.ShouldStop(1048576);
_uri = RemoteObject.createNew ("Object");Debug.locals.put("Uri", _uri);
 BA.debugLineNum = 86;BA.debugLine="Dim iStream As InputStream";
Debug.ShouldStop(2097152);
...
Debug.ShouldStop(268435456);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("jo", _jo);
 BA.debugLineNum = 94;BA.debugLine="jo = jo.InitializeStatic(\"anywheresoftware.b4a.ob";
Debug.ShouldStop(536870912);
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _jo.runMethod(false,"InitializeStatic",(Object)(RemoteObject.createImmutable("anywheresoftware.b4a.objects.streams.File"))).runMethod(false,"GetField",(Object)(RemoteObject.createImmutable("ContentDir"))));Debug.locals.put("jo", _jo);
 BA.debugLineNum = 95;BA.debugLine="Dim jo2 As Object";
Debug.ShouldStop(1073741824);
_jo2 = RemoteObject.createNew ("Object");Debug.locals.put("jo2", _jo2);
 BA.debugLineNum = 96;BA.debugLine="jo2 = jo";
Debug.ShouldStop(-2147483648);
_jo2 = (_jo.getObject());Debug.locals.put("jo2", _jo2);
 BA.debugLineNum = 97;BA.debugLine="Dim In As InputStream = File.OpenInput(jo2, UriSt";
Debug.ShouldStop(1);
...
_in = stegocamhandler.__c.getField(false,"File").runMethod(false,"OpenInput",(Object)(BA.ObjectToString(_jo2)),(Object)(_uristring));Debug.locals.put("In", _in);Debug.locals.put("In", _in);
 BA.debugLineNum = 100;BA.debugLine="Return iStream";
Debug.ShouldStop(8);
