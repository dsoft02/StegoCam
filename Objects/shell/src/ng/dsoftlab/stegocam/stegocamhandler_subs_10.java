...
public class stegocamhandler_subs_10 {
...
try {
		Debug.PushSubsStack("BytesToFile (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,206);
...
Debug.locals.put("Data", _data);
 BA.debugLineNum = 206;BA.debugLine="Sub BytesToFile (Dir As String, FileName As String";
Debug.ShouldStop(8192);
 BA.debugLineNum = 207;BA.debugLine="Dim out As OutputStream = File.OpenOutput(Dir, Fi";
...
try {
		Debug.PushSubsStack("CombineBytes (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,149);
...
Debug.locals.put("arr2", _arr2);
 BA.debugLineNum = 149;BA.debugLine="Sub CombineBytes(arr1() As Byte, arr2() As Byte) A";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 150;BA.debugLine="Dim res(arr1.Length + arr2.Length) As Byte";
...
_res = RemoteObject.createNewArray ("byte", new int[] {RemoteObject.solve(new RemoteObject[] {_arr1.getField(true,"length"),_arr2.getField(true,"length")}, "+",1, 1).<Integer>get().intValue()}, new Object[]{});Debug.locals.put("res", _res);
 BA.debugLineNum = 151;BA.debugLine="Dim bc As ByteConverter 'ByteConverter library";
Debug.ShouldStop(4194304);
_bc = RemoteObject.createNew ("anywheresoftware.b4a.agraham.byteconverter.ByteConverter");Debug.locals.put("bc", _bc);
 BA.debugLineNum = 152;BA.debugLine="bc.ArrayCopy(arr1, 0, res, 0, arr1.Length)";
...
_bc.runVoidMethod ("ArrayCopy",(Object)((_arr1)),(Object)(BA.numberCast(int.class, 0)),(Object)((_res)),(Object)(BA.numberCast(int.class, 0)),(Object)(_arr1.getField(true,"length")));
 BA.debugLineNum = 153;BA.debugLine="bc.ArrayCopy(arr2, 0, res, arr1.Length, arr2.Leng";
...
Debug.locals.put("cfilename", _cfilename);
 BA.debugLineNum = 100;BA.debugLine="Sub copyFiletoTemp(cfilename As String)";
Debug.ShouldStop(8);
 BA.debugLineNum = 101;BA.debugLine="Try";
Debug.ShouldStop(16);
try { BA.debugLineNum = 102;BA.debugLine="Msgbox(cfilename,\"cfile\")";
Debug.ShouldStop(32);
...
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("jo", _jo);
 BA.debugLineNum = 104;BA.debugLine="Dim Inp As InputStream  = GetStreamFromContentRe";
...
_inp = __ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_getstreamfromcontentresult" /*RemoteObject*/ ,(Object)(_cfilename));Debug.locals.put("Inp", _inp);Debug.locals.put("Inp", _inp);
 BA.debugLineNum = 105;BA.debugLine="Dim ofilename As String = \"stegofile.\" & file_ex";
...
_ofilename = RemoteObject.concat(RemoteObject.createImmutable("stegofile."),__ref.getField(true,"_file_extension" /*RemoteObject*/ ));Debug.locals.put("ofilename", _ofilename);Debug.locals.put("ofilename", _ofilename);
 BA.debugLineNum = 106;BA.debugLine="Dim Out As OutputStream = File.OpenOutput(File.D";
...
stegocamhandler.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence(stegocamhandler.__c.getField(false,"File").runMethod(true,"Exists",(Object)(stegocamhandler.__c.getField(false,"File").runMethod(true,"getDirInternalCache")),(Object)(_cfilename)))),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("exist"))),__ref.runMethod(false,"getActivityBA"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e12.toString()); BA.debugLineNum = 112;BA.debugLine="Msgbox(LastException.Message,\"\")";
Debug.ShouldStop(32768);
stegocamhandler.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence(stegocamhandler.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA")).runMethod(true,"getMessage"))),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable(""))),__ref.runMethod(false,"getActivityBA"));
 BA.debugLineNum = 113;BA.debugLine="Log(\":: issue \" & LastException)";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("createTempCoverImage (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,169);
...
Debug.locals.put("img", _img);
 BA.debugLineNum = 169;BA.debugLine="Sub createTempCoverImage(img As ImageView)";
Debug.ShouldStop(256);
 BA.debugLineNum = 171;BA.debugLine="Dim Bitmap1 As Bitmap = img.Bitmap";
Debug.ShouldStop(1024);
...
_bitmap1 = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper"), _img.runMethod(false,"getBitmap"));Debug.locals.put("Bitmap1", _bitmap1);Debug.locals.put("Bitmap1", _bitmap1);
 BA.debugLineNum = 172;BA.debugLine="Dim Out As OutputStream";
Debug.ShouldStop(2048);
_out = RemoteObject.createNew ("anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper");Debug.locals.put("Out", _out);
 BA.debugLineNum = 174;BA.debugLine="Out = File.OpenOutput(File.DirInternalCache, \"st";
Debug.ShouldStop(8192);
_out = stegocamhandler.__c.getField(false,"File").runMethod(false,"OpenOutput",(Object)(stegocamhandler.__c.getField(false,"File").runMethod(true,"getDirInternalCache")),(Object)(BA.ObjectToString("stegocover.png")),(Object)(stegocamhandler.__c.getField(true,"False")));Debug.locals.put("Out", _out);
 BA.debugLineNum = 175;BA.debugLine="Bitmap1.WriteToStream(Out, 100, \"PNG\")";
Debug.ShouldStop(16384);
_bitmap1.runVoidMethod ("WriteToStream",(Object)((_out.getObject())),(Object)(BA.numberCast(int.class, 100)),(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.Bitmap.CompressFormat"),RemoteObject.createImmutable("PNG"))));
 BA.debugLineNum = 176;BA.debugLine="Out.Close";
Debug.ShouldStop(32768);
_out.runVoidMethod ("Close");
...
try {
		Debug.PushSubsStack("deleteTempResources (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,200);
...
Debug.locals.put("res", _res);
 BA.debugLineNum = 200;BA.debugLine="Sub deleteTempResources(res As String)";
Debug.ShouldStop(128);
 BA.debugLineNum = 201;BA.debugLine="If res =\"stegocover\" Then";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("=",_res,BA.ObjectToString("stegocover"))) { 
 BA.debugLineNum = 202;BA.debugLine="File.Delete(File.DirInternalCache, \"stegocover.p";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("ExtractTextWithPassword (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,159);
...
Debug.locals.put("password", _password);
 BA.debugLineNum = 159;BA.debugLine="Public Sub ExtractTextWithPassword(imageFilePath A";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 161;BA.debugLine="steg.ExtractToString2(imageFilePath, password, \"s";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("file_Embedded (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,117);
...
Debug.locals.put("OutFileName", _outfilename);
 BA.debugLineNum = 117;BA.debugLine="Sub file_Embedded(OutFileName As String)";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 118;BA.debugLine="Try";
Debug.ShouldStop(2097152);
try { BA.debugLineNum = 120;BA.debugLine="Dim imageBytes() As Byte = File.ReadBytes(OutFil";
Debug.ShouldStop(8388608);
_imagebytes = stegocamhandler.__c.getField(false,"File").runMethod(false,"ReadBytes",(Object)(_outfilename),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("imageBytes", _imagebytes);Debug.locals.put("imageBytes", _imagebytes);
 BA.debugLineNum = 122;BA.debugLine="Dim textStr As String = \"FILE_\" & file_extension";
Debug.ShouldStop(33554432);
_textstr = RemoteObject.concat(RemoteObject.createImmutable("FILE_"),__ref.getField(true,"_file_extension" /*RemoteObject*/ ));Debug.locals.put("textStr", _textstr);Debug.locals.put("textStr", _textstr);
 BA.debugLineNum = 125;BA.debugLine="Dim textBytes() As Byte = textStr.GetBytes(\"UTF8";
Debug.ShouldStop(268435456);
_textbytes = _textstr.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")));Debug.locals.put("textBytes", _textbytes);Debug.locals.put("textBytes", _textbytes);
 BA.debugLineNum = 128;BA.debugLine="Dim modifiedBytes() As Byte =CombineBytes(stegoC";
Debug.ShouldStop(-2147483648);
_modifiedbytes = __ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_combinebytes" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_stegocambytes" /*RemoteObject*/ )),(Object)(_textbytes));Debug.locals.put("modifiedBytes", _modifiedbytes);Debug.locals.put("modifiedBytes", _modifiedbytes);
 BA.debugLineNum = 131;BA.debugLine="Dim newImageBytes() As Byte = CombineBytes(image";
Debug.ShouldStop(4);
_newimagebytes = __ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_combinebytes" /*RemoteObject*/ ,(Object)(_imagebytes),(Object)(_modifiedbytes));Debug.locals.put("newImageBytes", _newimagebytes);Debug.locals.put("newImageBytes", _newimagebytes);
 BA.debugLineNum = 134;BA.debugLine="File.WriteBytes(OutFileName,\"\", newImageBytes)";
Debug.ShouldStop(32);
stegocamhandler.__c.getField(false,"File").runVoidMethod ("WriteBytes",(Object)(_outfilename),(Object)(BA.ObjectToString("")),(Object)(_newimagebytes));
 BA.debugLineNum = 137;BA.debugLine="File.Copy(OutFileName,\"\",config.stegoImagePath,c";
Debug.ShouldStop(256);
stegocamhandler.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(_outfilename),(Object)(BA.ObjectToString("")),(Object)(stegocamhandler._config._stegoimagepath /*RemoteObject*/ ),(Object)(__ref.getField(true,"_curfilename" /*RemoteObject*/ )));
 BA.debugLineNum = 138;BA.debugLine="embeddingSuccessful =File.Exists(config.stegoIma";
Debug.ShouldStop(512);
__ref.setField ("_embeddingsuccessful" /*RemoteObject*/ ,stegocamhandler.__c.getField(false,"File").runMethod(true,"Exists",(Object)(stegocamhandler._config._stegoimagepath /*RemoteObject*/ ),(Object)(__ref.getField(true,"_curfilename" /*RemoteObject*/ ))));
 BA.debugLineNum = 139;BA.debugLine="lastErrorMessage=\"\"";
Debug.ShouldStop(1024);
__ref.setField ("_lasterrormessage" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 141;BA.debugLine="File.Delete(OutFileName,\"\")";
Debug.ShouldStop(4096);
stegocamhandler.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(_outfilename),(Object)(RemoteObject.createImmutable("")));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e13) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e13.toString()); BA.debugLineNum = 143;BA.debugLine="embeddingSuccessful =False";
Debug.ShouldStop(16384);
__ref.setField ("_embeddingsuccessful" /*RemoteObject*/ ,stegocamhandler.__c.getField(true,"False"));
 BA.debugLineNum = 144;BA.debugLine="lastErrorMessage=\"Embedding Failed: \" & LastExce";
Debug.ShouldStop(32768);
__ref.setField ("_lasterrormessage" /*RemoteObject*/ ,RemoteObject.concat(RemoteObject.createImmutable("Embedding Failed: "),stegocamhandler.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA")).runMethod(true,"getMessage")));
 BA.debugLineNum = 145;BA.debugLine="ToastMessageShow(\"Embedding Failed: \" & LastExce";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("FileToBytes (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,212);
if (RapidSub.canDelegate("filetobytes")) { return __ref.runUserSub(false, "stegocamhandler","filetobytes", __ref, _dir, _filename);}
Debug.locals.put("Dir", _dir);
Debug.locals.put("FileName", _filename);
 BA.debugLineNum = 212;BA.debugLine="Sub FileToBytes (Dir As String, FileName As String";
Debug.ShouldStop(524288);
 BA.debugLineNum = 213;BA.debugLine="Return Bit.InputStreamToBytes(File.OpenInput(Dir,";
Debug.ShouldStop(1048576);
...
Debug.ShouldStop(134217728);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("jo", _jo);
 BA.debugLineNum = 93;BA.debugLine="Dim cd As String = jo.InitializeStatic(\"anywheres";
Debug.ShouldStop(268435456);
_cd = BA.ObjectToString(_jo.runMethod(false,"InitializeStatic",(Object)(RemoteObject.createImmutable("anywheresoftware.b4a.objects.streams.File"))).runMethod(false,"GetField",(Object)(RemoteObject.createImmutable("ContentDir"))));Debug.locals.put("cd", _cd);Debug.locals.put("cd", _cd);
 BA.debugLineNum = 94;BA.debugLine="iStream = File.OpenInput(cd , UriString)";
Debug.ShouldStop(536870912);
_istream = stegocamhandler.__c.getField(false,"File").runMethod(false,"OpenInput",(Object)(_cd),(Object)(_uristring));Debug.locals.put("iStream", _istream);
...
try {
		Debug.PushSubsStack("isCoverImage (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,194);
if (RapidSub.canDelegate("iscoverimage")) { return __ref.runUserSub(false, "stegocamhandler","iscoverimage", __ref);}
 BA.debugLineNum = 194;BA.debugLine="Sub isCoverImage() As Boolean";
Debug.ShouldStop(2);
 BA.debugLineNum = 195;BA.debugLine="Return File.Exists(File.DirInternalCache, \"stegoc";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("steg_StringExtracted (stegocamhandler) ","stegocamhandler",8,__ref.getField(false, "ba"),__ref,164);
...
Debug.locals.put("SecretMessage", _secretmessage);
 BA.debugLineNum = 164;BA.debugLine="Sub steg_StringExtracted(SecretMessage As String)";
Debug.ShouldStop(8);
 BA.debugLineNum = 165;BA.debugLine="Log(\"Extracted Text: \" & SecretMessage)";
Debug.ShouldStop(16);
