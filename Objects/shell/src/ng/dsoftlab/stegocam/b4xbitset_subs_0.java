...
try {
		Debug.PushSubsStack("Clear (b4xbitset) ","b4xbitset",17,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("Get (b4xbitset) ","b4xbitset",17,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("getSize (b4xbitset) ","b4xbitset",17,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("Initialize (b4xbitset) ","b4xbitset",17,__ref.getField(false, "ba"),__ref,10);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xbitset.class, "_clear" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Set (b4xbitset) ","b4xbitset",17,__ref.getField(false, "ba"),__ref,16);
