...
public class stegocamhandler_subs_19 {
...
Debug.ShouldStop(32);
try { BA.debugLineNum = 104;BA.debugLine="Dim jo As JavaObject";
...
_returnfilepath = stegocamhandler.__c.getField(false,"File").runMethod(true,"Combine",(Object)(stegocamhandler.__c.getField(false,"File").runMethod(true,"getDirInternalCache")),(Object)(_ofilename));Debug.locals.put("returnFilePath", _returnfilepath);
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e12.toString()); BA.debugLineNum = 113;BA.debugLine="returnFilePath=\"\"";
Debug.ShouldStop(65536);
...
RemoteObject _secretmessage = null;
...
_stegofilepath = __ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_copyfiletotemp" /*RemoteObject*/ ,(Object)(_secretfile));Debug.locals.put("stegoFilePath", _stegofilepath);Debug.locals.put("stegoFilePath", _stegofilepath);
 BA.debugLineNum = 66;BA.debugLine="Dim SecretMessage() As Byte = Bit.InputStreamToB";
Debug.ShouldStop(2);
_secretmessage = stegocamhandler.__c.getField(false,"Bit").runMethod(false,"InputStreamToBytes",(Object)((stegocamhandler.__c.getField(false,"File").runMethod(false,"OpenInput",(Object)(_stegofilepath),(Object)(RemoteObject.createImmutable(""))).getObject())));Debug.locals.put("SecretMessage", _secretmessage);Debug.locals.put("SecretMessage", _secretmessage);
...
_outputfilepath = stegocamhandler.__c.getField(false,"File").runMethod(true,"Combine",(Object)(stegocamhandler.__c.getField(false,"File").runMethod(true,"getDirInternalCache")),(Object)(__ref.runClassMethod (ng.dsoftlab.stegocam.stegocamhandler.class, "_generatefilename" /*RemoteObject*/ )));Debug.locals.put("outputFilePath", _outputfilepath);Debug.locals.put("outputFilePath", _outputfilepath);
 BA.debugLineNum = 74;BA.debugLine="steg.EmbedArray2 (imageFilePath, outputFilePath,";
Debug.ShouldStop(512);
__ref.getField(false,"_steg" /*RemoteObject*/ ).runVoidMethod ("EmbedArray2",__ref.getField(false, "ba"),(Object)(_imagefilepath),(Object)(_outputfilepath),(Object)(_secretmessage),(Object)(BA.numberCast(int.class, 100)),(Object)(_password),(Object)(RemoteObject.createImmutable("file")));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e9) {
