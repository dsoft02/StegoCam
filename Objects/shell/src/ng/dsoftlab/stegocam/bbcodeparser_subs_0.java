...
bbcodeparser._allowedtags = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xset");__ref.setField("_allowedtags",bbcodeparser._allowedtags);
...
bbcodeparser._mtextengine = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine");__ref.setField("_mtextengine",bbcodeparser._mtextengine);
...
try {
		Debug.PushSubsStack("CreateRuns (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,182);
...
RemoteObject _textnode = RemoteObject.declareNull("ng.dsoftlab.stegocam.bbcodeparser._bbcodetextnode");
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_texttorun" /*RemoteObject*/ ,(Object)(_textnode),(Object)(_runs),(Object)(_data));
 }
}Debug.locals.put("TextNode", _textnode);
;
 BA.debugLineNum = 188;BA.debugLine="Return Runs";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _runs;
...
try {
		Debug.PushSubsStack("CreateTagNode (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,174);
if (RapidSub.canDelegate("createtagnode")) { return __ref.runUserSub(false, "bbcodeparser","createtagnode", __ref, _tag);}
RemoteObject _n = RemoteObject.declareNull("ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode");
...
Debug.JustUpdateDeviceLine();
_n = RemoteObject.createNew ("ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode");Debug.locals.put("n", _n);
...
try {
		Debug.PushSubsStack("CreateTextNode (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,164);
if (RapidSub.canDelegate("createtextnode")) { return __ref.runUserSub(false, "bbcodeparser","createtextnode", __ref, _text);}
RemoteObject _n = RemoteObject.declareNull("ng.dsoftlab.stegocam.bbcodeparser._bbcodetextnode");
...
Debug.JustUpdateDeviceLine();
_n = RemoteObject.createNew ("ng.dsoftlab.stegocam.bbcodeparser._bbcodetextnode");Debug.locals.put("n", _n);
...
try {
		Debug.PushSubsStack("Error (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,154);
...
Debug.JustUpdateDeviceLine();
bbcodeparser.__c.runVoidMethod ("LogImpl","98978435",_s,bbcodeparser.__c.getField(false,"Colors").getField(true,"Red"));
...
try {
		Debug.PushSubsStack("GetDimensionFromTag (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,371);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_v,_data.getField(true,"Width" /*RemoteObject*/ )}, "*",0, 0));
 };
 };
 BA.debugLineNum = 382;BA.debugLine="Return DipToCurrent(s)";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return bbcodeparser.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, _s)));
...
try {
		Debug.PushSubsStack("GetView (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,438);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Missing view: "),_id)));
 };
...
try {
		Debug.PushSubsStack("HandleListElement (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,344);
if (RapidSub.canDelegate("handlelistelement")) { return __ref.runUserSub(false, "bbcodeparser","handlelistelement", __ref, _text, _run);}
int _i = 0;
RemoteObject _tag = RemoteObject.declareNull("ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode");
...
Debug.JustUpdateDeviceLine();
_parent = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createconnectedparent" /*RemoteObject*/ );Debug.locals.put("parent", _parent);Debug.locals.put("parent", _parent);
 BA.debugLineNum = 355;BA.debugLine="Run.TextChars = mTextEngine.CreateBCTextCharsF";
Debug.JustUpdateDeviceLine();
_run.setField ("TextChars" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(RemoteObject.concat((_count),RemoteObject.createImmutable(". ")))));
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _run;
...
try {
		Debug.PushSubsStack("Initialize (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("Parse (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,37);
...
RemoteObject _t = RemoteObject.declareNull("ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode");
RemoteObject _n = RemoteObject.declareNull("ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode");
Debug.locals.put("Data", _data);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_stack" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_createtagnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("noop"))))));
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_createtextnode" /*RemoteObject*/ ,(Object)(_data.getField(true,"Text" /*RemoteObject*/ ).runMethod(true,"substring",(Object)(_lastmatchend),(Object)(__ref.getField(true,"_start" /*RemoteObject*/ ))))))));
 };
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_stackpeek" /*RemoteObject*/ ).getField(true,"Tag" /*RemoteObject*/ ),_tag)) { 
 BA.debugLineNum = 55;BA.debugLine="If StackPeek.CanHaveNestedTags = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_stackpeek" /*RemoteObject*/ ).getField(true,"CanHaveNestedTags" /*RemoteObject*/ ),bbcodeparser.__c.getField(true,"False"))) { 
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Closing tag does not match: "),_tag)));
 BA.debugLineNum = 59;BA.debugLine="Return Null";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), bbcodeparser.__c.getField(false,"Null"));
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_stackpop" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
_t = __ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_parsetag" /*RemoteObject*/ ,(Object)(_tag));Debug.locals.put("t", _t);Debug.locals.put("t", _t);
 BA.debugLineNum = 79;BA.debugLine="If AllowedTags.Contains(t.Tag) = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_allowedtags" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_t.getField(true,"Tag" /*RemoteObject*/ )))),bbcodeparser.__c.getField(true,"False"))) { 
 BA.debugLineNum = 80;BA.debugLine="Error(\"Invalid tag: \" & tag)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Invalid tag: "),_tag)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_stackpush" /*RemoteObject*/ ,(Object)(_t));
...
Debug.JustUpdateDeviceLine();
_n = __ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_stackpeek" /*RemoteObject*/ );Debug.locals.put("n", _n);Debug.locals.put("n", _n);
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_createtextnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable(""))))));
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_createtextnode" /*RemoteObject*/ ,(Object)(_data.getField(true,"Text" /*RemoteObject*/ ).runMethod(true,"substring",(Object)(_lastmatchend),(Object)(_data.getField(true,"Text" /*RemoteObject*/ ).runMethod(true,"length"))))))));
 };
 BA.debugLineNum = 99;BA.debugLine="Return ParsedElements";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _parsedelements;
...
try {
		Debug.PushSubsStack("ParseCodepoint (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,325);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return bbcodeparser.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_raw),(Object)(BA.numberCast(int.class, 16)));
...
try {
		Debug.PushSubsStack("ParseColorString (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,330);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return bbcodeparser.__c.getField(false,"Bit").runMethod(true,"Or",(Object)(BA.numberCast(int.class, ((int)0xff000000))),(Object)(bbcodeparser.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_clr.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 1)))),(Object)(BA.numberCast(int.class, 16)))));
 }else 
{ BA.debugLineNum = 334;BA.debugLine="Else If clr.StartsWith(\"0x\") Then";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return bbcodeparser.__c.getField(false,"Bit").runMethod(true,"Or",(Object)(BA.numberCast(int.class, ((int)0xff000000))),(Object)(bbcodeparser.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_clr.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 4)))),(Object)(BA.numberCast(int.class, 16)))));
 }else 
{ BA.debugLineNum = 336;BA.debugLine="Else If ColorsMap.ContainsKey(clr) Then";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(int.class, __ref.getField(false,"_colorsmap" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_clr))));
 }else {
 BA.debugLineNum = 339;BA.debugLine="Error(\"Invalid color value: \" & clr)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Invalid color value: "),_clr)));
 BA.debugLineNum = 340;BA.debugLine="Return xui.Color_Black";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Black");
 }}}
;
...
try {
		Debug.PushSubsStack("ParseTag (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,102);
if (RapidSub.canDelegate("parsetag")) { return __ref.runUserSub(false, "bbcodeparser","parsetag", __ref, _tag);}
RemoteObject _res = RemoteObject.declareNull("ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode");
RemoteObject _i = RemoteObject.createImmutable(0);
...
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_createtagnode" /*RemoteObject*/ ,(Object)(_tag.runMethod(true,"toLowerCase")));};
 BA.debugLineNum = 107;BA.debugLine="Dim res As BBCodeTagNode = CreateTagNode(\"\")";
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_createtagnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
try {
		Debug.PushSubsStack("SetImageView (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,392);
...
public ResumableSub_SetImageView(ng.dsoftlab.stegocam.bbcodeparser parent,RemoteObject __ref,RemoteObject _tag,RemoteObject _run,RemoteObject _data) {
this.parent = parent;
this.__ref = __ref;
this._tag = _tag;
this._run = _run;
...
RemoteObject _j = RemoteObject.declareNull("ng.dsoftlab.stegocam.httpjob");
...
Debug.JustUpdateDeviceLine();
_width = __ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("width")),(Object)(_data));Debug.locals.put("width", _width);Debug.locals.put("width", _width);
 BA.debugLineNum = 397;BA.debugLine="Dim height As Int = GetDimensionFromTag(Tag, \"hei";
Debug.JustUpdateDeviceLine();
_height = __ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("height")),(Object)(_data));Debug.locals.put("height", _height);Debug.locals.put("height", _height);
...
Debug.JustUpdateDeviceLine();
_j = RemoteObject.createNew ("ng.dsoftlab.stegocam.httpjob");Debug.locals.put("j", _j);
 BA.debugLineNum = 412;BA.debugLine="j.Initialize(\"\", Me)";
Debug.JustUpdateDeviceLine();
_j.runClassMethod (ng.dsoftlab.stegocam.httpjob.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(BA.ObjectToString("")),(Object)(__ref));
 BA.debugLineNum = 413;BA.debugLine="j.Download(url)";
Debug.JustUpdateDeviceLine();
_j.runClassMethod (ng.dsoftlab.stegocam.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(_url));
...
Debug.JustUpdateDeviceLine();
_bmp = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper"), _j.runClassMethod (ng.dsoftlab.stegocam.httpjob.class, "_getbitmap" /*RemoteObject*/ ).getObject());Debug.locals.put("bmp", _bmp);
...
Debug.JustUpdateDeviceLine();
_j.runClassMethod (ng.dsoftlab.stegocam.httpjob.class, "_release" /*RemoteObject*/ );
 if (true) break;
...
{ BA.debugLineNum = 426;BA.debugLine="Else if width > -1 And height > -1 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_width,BA.numberCast(double.class, -(double) (0 + 1))) && RemoteObject.solveBoolean(">",_height,BA.numberCast(double.class, -(double) (0 + 1)))) { 
this.state = 20;
}else 
{ BA.debugLineNum = 428;BA.debugLine="Else if width > -1 Then";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("StackPeek (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,150);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return (__ref.getField(false,"_stack" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_stack" /*RemoteObject*/ ).runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1))));
...
try {
		Debug.PushSubsStack("StackPop (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,142);
...
try {
		Debug.PushSubsStack("StackPush (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,146);
...
try {
		Debug.PushSubsStack("TextToRun (bbcodeparser) ","bbcodeparser",30,__ref.getField(false, "ba"),__ref,191);
...
int _i = 0;
RemoteObject _tag = RemoteObject.declareNull("ng.dsoftlab.stegocam.bbcodeparser._bbcodetagnode");
RemoteObject _uu = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcstyledunderline");
RemoteObject _url = RemoteObject.createImmutable("");
...
Debug.JustUpdateDeviceLine();
_run = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createrun" /*RemoteObject*/ ,(Object)(_text.getField(true,"Text" /*RemoteObject*/ )));Debug.locals.put("Run", _run);Debug.locals.put("Run", _run);
...
Debug.JustUpdateDeviceLine();
_uu = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcstyledunderline");Debug.locals.put("uu", _uu);
...
_uu.setField ("Clr" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_parsecolorstring" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("color"))))))));}
else {
...
Debug.JustUpdateDeviceLine();
_run.setField ("TextColor" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_parsecolorstring" /*RemoteObject*/ ,(Object)(_clr)));
 break; }
case 4: {
 BA.debugLineNum = 233;BA.debugLine="SetImageView(tag, Run, Data)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_setimageview" /*void*/ ,(Object)(_tag),(Object)(_run),(Object)(_data));
...
Debug.JustUpdateDeviceLine();
_run.setField ("VerticalOffset" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("vertical")),(Object)(_data)));
 };
...
Debug.JustUpdateDeviceLine();
_run.setField ("View" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_getview" /*RemoteObject*/ ,(Object)(_tag),(Object)(_data)));
...
_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"setWidth",__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("width")),(Object)(_data)));};
...
_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"setHeight",__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("height")),(Object)(_data)));};
...
Debug.JustUpdateDeviceLine();
bbcodeparser.__c.runVoidMethod ("LogImpl","99240637",RemoteObject.concat(RemoteObject.createImmutable("Font missing from TextEngine.CustomFonts: "),_name),0);
 }else {
...
Debug.JustUpdateDeviceLine();
_cr.setField ("ConnectedWidth" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("minwidth")),(Object)(_data)));
...
Debug.JustUpdateDeviceLine();
_run = __ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_handlelistelement" /*RemoteObject*/ ,(Object)(_text),(Object)(_run));Debug.locals.put("Run", _run);
 };
