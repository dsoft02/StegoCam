...
try {
		Debug.PushSubsStack("Base_Resize (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,105);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_parseanddraw" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 113;BA.debugLine="Redraw";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_redraw" /*RemoteObject*/ );
 };
 };
...
bbcodeview._style = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle");__ref.setField("_style",bbcodeview._style);
 //BA.debugLineNum = 12;BA.debugLine="Private mTextEngine As BCTextEngine";
bbcodeview._mtextengine = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine");__ref.setField("_mtextengine",bbcodeview._mtextengine);
...
bbcodeview._paragraph = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcparagraph");__ref.setField("_paragraph",bbcodeview._paragraph);
...
bbcodeview._parsedata = RemoteObject.createNew ("ng.dsoftlab.stegocam.bbcodeparser._bbcodeparsedata");__ref.setField("_parsedata",bbcodeview._parsedata);
...
bbcodeview._usedimageviews = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xorderedmap");__ref.setField("_usedimageviews",bbcodeview._usedimageviews);
...
try {
		Debug.PushSubsStack("CleanExistingImageViews (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,182);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_invisibleonly,bbcodeview.__c.getField(true,"False")) || RemoteObject.solveBoolean("=",__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_lineisvisible" /*RemoteObject*/ ,(Object)(_line),(Object)(_offset),(Object)(_height)),bbcodeview.__c.getField(true,"False"))) { 
...
__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_line)));};
 };
 }
}Debug.locals.put("Line", _line);
;
...
try {
		Debug.PushSubsStack("CollectURLs (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,304);
...
RemoteObject _st = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection");
RemoteObject _extra = RemoteObject.declareNull("ng.dsoftlab.stegocam.bbcodeview._internalbbviewurl");
...
Debug.JustUpdateDeviceLine();
_extra = RemoteObject.createNew ("ng.dsoftlab.stegocam.bbcodeview._internalbbviewurl");Debug.locals.put("extra", _extra);
...
Debug.JustUpdateDeviceLine();
_extra = __ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_createbcurlextradata" /*RemoteObject*/ );Debug.locals.put("extra", _extra);
...
try {
		Debug.PushSubsStack("CreateBCURLExtraData (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,325);
if (RapidSub.canDelegate("createbcurlextradata")) { return __ref.runUserSub(false, "bbcodeview","createbcurlextradata", __ref);}
RemoteObject _t1 = RemoteObject.declareNull("ng.dsoftlab.stegocam.bbcodeview._internalbbviewurl");
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("ng.dsoftlab.stegocam.bbcodeview._internalbbviewurl");Debug.locals.put("t1", _t1);
...
try {
		Debug.PushSubsStack("DesignerCreateView (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("DrawVisibleRegion (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,141);
...
try {
		Debug.PushSubsStack("FindTouchedRun (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,269);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _single.getField(false,"Run" /*RemoteObject*/ );
 };
 }
}Debug.locals.put("offsety", _offsety);
;
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return (bbcodeview.__c.getField(false,"Null"));
...
try {
		Debug.PushSubsStack("getText (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("getTextEngine (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,128);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_mtextengine" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("getViews (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,51);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_parsedata" /*RemoteObject*/ ).getField(false,"Views" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Initialize (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("LineIsVisible (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,178);
...
try {
		Debug.PushSubsStack("MarkURL (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,281);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_containskey" /*RemoteObject*/ ,(Object)((_line))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("ParseAndDraw (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,195);
...
_pe = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).getField(false,"_tagparser" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_parse" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_parsedata" /*RemoteObject*/ )));Debug.locals.put("pe", _pe);Debug.locals.put("pe", _pe);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_runs" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).getField(false,"_tagparser" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_createruns" /*RemoteObject*/ ,(Object)(_pe),(Object)(__ref.getField(false,"_parsedata" /*RemoteObject*/ ))));
 };
...
try {
		Debug.PushSubsStack("Redraw (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,216);
...
Debug.JustUpdateDeviceLine();
bbcodeview._style = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createstyle" /*RemoteObject*/ );__ref.setField("_style",bbcodeview._style);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_collecturls" /*RemoteObject*/ );
 };
 BA.debugLineNum = 231;BA.debugLine="DrawVisibleRegion";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_drawvisibleregion" /*RemoteObject*/ );
 }else {
...
try {
		Debug.PushSubsStack("setText (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,132);
...
try {
		Debug.PushSubsStack("setTextEngine (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,118);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_settext" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
 };
...
try {
		Debug.PushSubsStack("setViews (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("sv_ScrollChanged (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,339);
...
try {
		Debug.PushSubsStack("TouchPanel_Touch (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,240);
...
Debug.JustUpdateDeviceLine();
_run = __ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_findtouchedrun" /*RemoteObject*/ ,(Object)(_x),(Object)(_y));Debug.locals.put("run", _run);
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_markurl" /*RemoteObject*/ ,(Object)((bbcodeview.__c.getField(false,"Null"))));
 }else 
{ BA.debugLineNum = 250;BA.debugLine="Else If (xui.IsB4i And Action = 4) Or (xui.IsB4A";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_markurl" /*RemoteObject*/ ,(Object)(_run));
 }}
;
...
try {
		Debug.PushSubsStack("UpdateVisibleRegion (bbcodeview) ","bbcodeview",31,__ref.getField(false, "ba"),__ref,147);
...
Debug.JustUpdateDeviceLine();
_existing.runVoidMethod ("AddAll",(Object)(__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ )));
 BA.debugLineNum = 152;BA.debugLine="CleanExistingImageViews(True, Existing, OffsetY,";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_cleanexistingimageviews" /*RemoteObject*/ ,(Object)(bbcodeview.__c.getField(true,"True")),(Object)(_existing),(Object)(_offsety),(Object)(_height));
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (ng.dsoftlab.stegocam.bbcodeview.class, "_lineisvisible" /*RemoteObject*/ ,(Object)(_line),(Object)(_offsety),(Object)(_height)).<Boolean>get().booleanValue()) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_drawsingleline" /*RemoteObject*/ ,(Object)(_line),(Object)(_xiv),(Object)(__ref.getField(false,"_paragraph" /*RemoteObject*/ )));
 BA.debugLineNum = 171;BA.debugLine="UsedImageViews.Put(Line, xiv)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_line)),(Object)((_xiv.getObject())));
 }else {
