...
public class stegocamhandler_subs_12 {
...
_out.runVoidMethod ("Close");
 BA.debugLineNum = 110;BA.debugLine="Msgbox(File.Exists(File.DirInternalCache, ofilen";
Debug.ShouldStop(8192);
stegocamhandler.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence(stegocamhandler.__c.getField(false,"File").runMethod(true,"Exists",(Object)(stegocamhandler.__c.getField(false,"File").runMethod(true,"getDirInternalCache")),(Object)(_ofilename)))),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("exist"))),__ref.runMethod(false,"getActivityBA"));
