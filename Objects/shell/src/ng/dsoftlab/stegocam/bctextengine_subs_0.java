...
try {
		Debug.PushSubsStack("AddLTRItems (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,340);
...
RemoteObject _lastun = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
RemoteObject _prev = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
int _i = 0;
RemoteObject _un = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_isunseparator" /*RemoteObject*/ ,(Object)((_ltrlist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))))).<Boolean>get().booleanValue()) { 
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_isunseparator" /*RemoteObject*/ ,(Object)((_ltrlist.runMethod(false,"Get",(Object)(_lastindex))))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("AddParagraphViews (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,219);
...
try {
		Debug.PushSubsStack("BytesToInt (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,907);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _cp;
...
bctextengine._defaultunderlinestyle = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcstyledunderline");__ref.setField("_defaultunderlinestyle",bctextengine._defaultunderlinestyle);
...
bctextengine._defaultstyle = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle");__ref.setField("_defaultstyle",bctextengine._defaultstyle);
...
bctextengine._tagparser = RemoteObject.createNew ("ng.dsoftlab.stegocam.bbcodeparser");__ref.setField("_tagparser",bctextengine._tagparser);
 //BA.debugLineNum = 51;BA.debugLine="Private EmptyTextChars As BCTextChars";
bctextengine._emptytextchars = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bctextchars");__ref.setField("_emptytextchars",bctextengine._emptytextchars);
 //BA.debugLineNum = 52;BA.debugLine="Private Emojis As B4XSet";
bctextengine._emojis = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xset");__ref.setField("_emojis",bctextengine._emojis);
...
bctextengine._vowelscodepoints = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xset");__ref.setField("_vowelscodepoints",bctextengine._vowelscodepoints);
 //BA.debugLineNum = 59;BA.debugLine="Private AsyncBCs As B4XOrderedMap";
bctextengine._asyncbcs = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xorderedmap");__ref.setField("_asyncbcs",bctextengine._asyncbcs);
...
bctextengine._rtlchars = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xset");__ref.setField("_rtlchars",bctextengine._rtlchars);
...
bctextengine._arabicnonlinkedletters = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xset");__ref.setField("_arabicnonlinkedletters",bctextengine._arabicnonlinkedletters);
 //BA.debugLineNum = 67;BA.debugLine="Private ArabicCharsConnectedPrev As B4XSet";
bctextengine._arabiccharsconnectedprev = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xset");__ref.setField("_arabiccharsconnectedprev",bctextengine._arabiccharsconnectedprev);
...
try {
		Debug.PushSubsStack("CreateBCTextChars (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1092);
...
RemoteObject _t1 = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bctextchars");
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bctextchars");Debug.locals.put("t1", _t1);
...
try {
		Debug.PushSubsStack("CreateBCTextCharsFromString (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1039);
...
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_loadarabicdata" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
_cp = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_bytestoint" /*RemoteObject*/ ,(Object)(_b),(Object)(RemoteObject.solve(new RemoteObject[] {_bi,RemoteObject.createImmutable(4)}, "*",0, 1)));Debug.locals.put("cp", _cp);Debug.locals.put("cp", _cp);
...
{ BA.debugLineNum = 1054;BA.debugLine="Else If i > 0 And (cp >= 0x1F3FB And cp <= 0x1F";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 1058;BA.debugLine="Else If i > 0 And (ThereAreVowels And VowelsCod";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 1062;BA.debugLine="Else If RTLAware And i > 0 And chars(i - 1) = \"";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 1075;BA.debugLine="Else If i > 0 And ShouldAddToPrevChar Then";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_preprocessarabic" /*RemoteObject*/ ,(Object)(_chars),(Object)(_i));
 };
 BA.debugLineNum = 1089;BA.debugLine="Return CreateBCTextChars(chars, 0, i)";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createbctextchars" /*RemoteObject*/ ,(Object)(_chars),(Object)(BA.numberCast(int.class, 0)),(Object)(_i));
...
try {
		Debug.PushSubsStack("CreateConnectedParent (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,158);
if (RapidSub.canDelegate("createconnectedparent")) { return __ref.runUserSub(false, "bctextengine","createconnectedparent", __ref);}
RemoteObject _connected = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcconnectedruns");
RemoteObject _parent = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bctextrun");
...
Debug.JustUpdateDeviceLine();
_connected = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcconnectedruns");Debug.locals.put("connected", _connected);
...
Debug.JustUpdateDeviceLine();
_parent = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createrun" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));Debug.locals.put("parent", _parent);Debug.locals.put("parent", _parent);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _parent;
...
try {
		Debug.PushSubsStack("CreateGlyph (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,815);
...
RemoteObject _g = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcglyph");
...
Debug.CheckDeviceExceptions();if (true) return _g;};
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createglyphfromdefaultcolor" /*RemoteObject*/ ,(Object)(_c),(Object)(_fontmetrics.getField(false,"DefaultColorMetrics" /*RemoteObject*/ )),(Object)(_fontmetrics.getField(true,"Clr" /*RemoteObject*/ )));
 }else {
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_rtlaware" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_recoloredgesofconnectedcharacters" /*RemoteObject*/ ,(Object)(_c),(Object)(_r2));};
...
{ BA.debugLineNum = 868;BA.debugLine="Else if c = \" \" Then";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 870;BA.debugLine="Else If c = \"x\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_c,BA.ObjectToString("x"))) { 
 BA.debugLineNum = 871;BA.debugLine="g = CreateGlyph(\"X\", FontMetrics, True)";
Debug.JustUpdateDeviceLine();
_g = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("X")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"True")));Debug.locals.put("g", _g);
 }else 
{ BA.debugLineNum = 872;BA.debugLine="Else If c = \"x x\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_c,BA.ObjectToString("x x"))) { 
 BA.debugLineNum = 873;BA.debugLine="g = CreateGlyph(\"X X\", FontMetrics, True)";
Debug.JustUpdateDeviceLine();
_g = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("X X")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"True")));Debug.locals.put("g", _g);
 }else {
 BA.debugLineNum = 875;BA.debugLine="g.Width = CreateGlyph(\" \", FontMetrics, False)";
Debug.JustUpdateDeviceLine();
_g.setField ("Width" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString(" ")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"False"))).getField(true,"Width" /*RemoteObject*/ ));
 }}}}
;
 };
 BA.debugLineNum = 878;BA.debugLine="If xui.IsB4J = False And MightBeAnEmoji(c) Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4J"),bctextengine.__c.getField(true,"False")) && RemoteObject.solveBoolean(".",__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_mightbeanemoji" /*RemoteObject*/ ,(Object)(_c)))) { 
...
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_loaddata" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_emojis" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("emoji-data.txt")));};
 BA.debugLineNum = 880;BA.debugLine="g.Emoji = Emojis.Contains(BytesToInt(c.GetBytes";
Debug.JustUpdateDeviceLine();
_g.setField ("Emoji" /*RemoteObject*/ ,__ref.getField(false,"_emojis" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_bytestoint" /*RemoteObject*/ ,(Object)(_c.runMethod(false,"getBytes",(Object)(__ref.getField(true,"_charset" /*RemoteObject*/ )))),(Object)(BA.numberCast(int.class, 0)))))));
 };
...
try {
		Debug.PushSubsStack("CreateGlyphFromDefaultColor (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,921);
...
RemoteObject _blackglyph = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcglyph");
RemoteObject _g = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcglyph");
...
Debug.JustUpdateDeviceLine();
_blackglyph = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(_c),(Object)(_defaultcolormetrics),(Object)(bctextengine.__c.getField(true,"False")));Debug.locals.put("BlackGlyph", _blackglyph);Debug.locals.put("BlackGlyph", _blackglyph);
...
Debug.CheckDeviceExceptions();if (true) return _blackglyph;};
...
try {
		Debug.PushSubsStack("CreateLine (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,398);
if (RapidSub.canDelegate("createline")) { return __ref.runUserSub(false, "bctextengine","createline", __ref, _p);}
RemoteObject _line = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bctextline");
...
Debug.JustUpdateDeviceLine();
_line = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bctextline");Debug.locals.put("line", _line);
...
try {
		Debug.PushSubsStack("CreateRun (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,146);
if (RapidSub.canDelegate("createrun")) { return __ref.runUserSub(false, "bctextengine","createrun", __ref, _text);}
RemoteObject _r = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bctextrun");
...
Debug.JustUpdateDeviceLine();
_r = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bctextrun");Debug.locals.put("r", _r);
...
Debug.JustUpdateDeviceLine();
_r.setField ("TextChars" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(_text)));
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _r;
...
try {
		Debug.PushSubsStack("CreateSingleSection (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,556);
...
RemoteObject _single = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection");
RemoteObject _prevchar = RemoteObject.createImmutable("");
RemoteObject _prevgo = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcglyphandoffset");
int _i = 0;
RemoteObject _s = RemoteObject.createImmutable("");
RemoteObject _go = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcglyphandoffset");
RemoteObject _g = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcglyph");
RemoteObject _u = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcstyledunderline");
...
Debug.JustUpdateDeviceLine();
_single = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection");Debug.locals.put("single", _single);
...
Debug.JustUpdateDeviceLine();
_prevgo = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcglyphandoffset");Debug.locals.put("PrevGO", _prevgo);
...
Debug.JustUpdateDeviceLine();
_go = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcglyphandoffset");Debug.locals.put("go", _go);
 BA.debugLineNum = 567;BA.debugLine="Dim g As BCGlyph = CreateGlyph(s, FontMetrics, F";
Debug.JustUpdateDeviceLine();
_g = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(_s),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"False")));Debug.locals.put("g", _g);Debug.locals.put("g", _g);
...
Debug.JustUpdateDeviceLine();
_prevgo.setField ("SpaceBetweenThisAndNext" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_getkernspacebetweenchars" /*RemoteObject*/ ,(Object)(_fontmetrics),(Object)(_prevchar),(Object)(_s),(Object)(_prevgo.getField(false,"Glyph" /*RemoteObject*/ )),(Object)(_g)));
 }else {
...
Debug.JustUpdateDeviceLine();
_u = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_getunderlinestyle" /*RemoteObject*/ ,(Object)(_run));Debug.locals.put("u", _u);Debug.locals.put("u", _u);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _single;
...
try {
		Debug.PushSubsStack("CreateStyle (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,135);
if (RapidSub.canDelegate("createstyle")) { return __ref.runUserSub(false, "bctextengine","createstyle", __ref);}
RemoteObject _s = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle");
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcparagraphstyle");Debug.locals.put("s", _s);
...
try {
		Debug.PushSubsStack("CreateUnbreakable (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,477);
...
RemoteObject _unbreakable = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
RemoteObject _single = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection");
Debug.locals.put("Run", _run);
Debug.locals.put("TextChars", _textchars);
Debug.locals.put("FontMetrics", _fontmetrics);
...
Debug.JustUpdateDeviceLine();
_unbreakable = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");Debug.locals.put("unbreakable", _unbreakable);
...
Debug.JustUpdateDeviceLine();
_single = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createsinglesection" /*RemoteObject*/ ,(Object)(_run),(Object)(_textchars),(Object)(_fontmetrics));Debug.locals.put("single", _single);Debug.locals.put("single", _single);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _unbreakable;
...
try {
		Debug.PushSubsStack("DetectRTL (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,493);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return bctextengine.__c.getField(true,"True");
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_loaddata" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_rtlchars" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("rtl-data.txt")));
 };
...
Debug.JustUpdateDeviceLine();
_cp = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_bytestoint" /*RemoteObject*/ ,(Object)(_firstchar.runMethod(false,"getBytes",(Object)(__ref.getField(true,"_charset" /*RemoteObject*/ )))),(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("cp", _cp);Debug.locals.put("cp", _cp);
 BA.debugLineNum = 502;BA.debugLine="Return RTLChars.Contains(cp)";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_rtlchars" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_cp)));
...
try {
		Debug.PushSubsStack("DrawLine (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,683);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_drawunbreakable" /*RemoteObject*/ ,(Object)(_un),(Object)(_offsety));
 }
}Debug.locals.put("un", _un);
;
...
try {
		Debug.PushSubsStack("DrawParagraph (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,617);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_drawline" /*RemoteObject*/ ,(Object)(_line),(Object)(_line.getField(true,"BaselineY" /*RemoteObject*/ )));
 }
}Debug.locals.put("line", _line);
;
...
try {
		Debug.PushSubsStack("DrawSingleLine (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,623);
...
Debug.JustUpdateDeviceLine();
_r = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_drawsinglelineshared" /*RemoteObject*/ ,(Object)(_line),(Object)(_iv),(Object)(_par));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
...
try {
		Debug.PushSubsStack("DrawSingleLineAsync (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,640);
...
__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));};
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_asyncbc" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_findasyncbc" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _r.runMethod(true,"getWidth"))),(Object)(BA.numberCast(int.class, _r.runMethod(true,"getHeight")))));
 BA.debugLineNum = 648;BA.debugLine="AsyncTasks.Add(AsyncBC.AsyncDrawRect(r, GetBrush";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asynctasks" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.getField(false,"_asyncbc" /*RemoteObject*/ ).runMethod(false,"_asyncdrawrect",(Object)(_r),(Object)(__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_getbrush" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")))),(Object)(bctextengine.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0))))));
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_asyncbc" /*RemoteObject*/ );
 };
 BA.debugLineNum = 654;BA.debugLine="Return Null";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return (bctextengine.__c.getField(false,"Null"));
...
try {
		Debug.PushSubsStack("DrawSingleLineShared (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,632);
...
try {
		Debug.PushSubsStack("DrawSingleStyleSection (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,695);
...
_g = _go.getField(false,"Glyph" /*RemoteObject*/ );Debug.locals.put("g", _g);Debug.locals.put("g", _g);
 BA.debugLineNum = 702;BA.debugLine="If g = Null Then Continue";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("n",_g)) { 
if (true) continue;};
...
Debug.JustUpdateDeviceLine();
_u = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_getunderlinestyle" /*RemoteObject*/ ,(Object)(_single.getField(false,"Run" /*RemoteObject*/ )));Debug.locals.put("u", _u);Debug.locals.put("u", _u);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_foregroundbc" /*RemoteObject*/ ).runVoidMethod ("_drawrect2",(Object)(_r),(Object)(__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_getbrush" /*RemoteObject*/ ,(Object)(_clr))),(Object)(bctextengine.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0)));
 };
 };
...
try {
		Debug.PushSubsStack("DrawText (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,203);
...
RemoteObject _par = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcparagraph");
...
Debug.JustUpdateDeviceLine();
_par = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_prepare" /*RemoteObject*/ ,(Object)(_runs),(Object)(_style));Debug.locals.put("par", _par);Debug.locals.put("par", _par);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_drawparagraph" /*RemoteObject*/ ,(Object)(_par));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_resizeimageview" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_foregroundbc" /*RemoteObject*/ )),(Object)(_par),(Object)(_foregroundimageview),(Object)(_par.getField(false,"Style" /*RemoteObject*/ ).getField(true,"ResizeHeightAutomatically" /*RemoteObject*/ )));
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_addparagraphviews" /*RemoteObject*/ ,(Object)(_par));
 BA.debugLineNum = 216;BA.debugLine="Return par";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _par;
...
try {
		Debug.PushSubsStack("DrawUnbreakable (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,689);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_drawsinglestylesection" /*RemoteObject*/ ,(Object)(_single),(Object)(_offsety));
 }
}Debug.locals.put("single", _single);
;
...
try {
		Debug.PushSubsStack("FindAsyncBC (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,657);
...
Debug.JustUpdateDeviceLine();
{
final RemoteObject group1 = __ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ );
final int groupLen1 = group1.runMethod(true,"getSize").<Integer>get()
;int index1 = 0;
;
for (; index1 < groupLen1;index1++){
...
Debug.JustUpdateDeviceLine();
_used = BA.ObjectToBoolean(__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_bc))));Debug.locals.put("Used", _used);Debug.locals.put("Used", _used);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_bc)),(Object)((bctextengine.__c.getField(true,"True"))));
...
Debug.JustUpdateDeviceLine();
{
final RemoteObject group14 = __ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_getvalues" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("FindMinRect (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,971);
...
try {
		Debug.PushSubsStack("FindSingleStyleSection (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,763);
...
RemoteObject _line = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bctextline");
RemoteObject _un = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
RemoteObject _s = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection");
Debug.locals.put("Paragraph", _paragraph);
Debug.locals.put("X", _x);
Debug.locals.put("Y", _y);
...
try {
		Debug.PushSubsStack("FontToKey (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,999);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return BA.NumberToString(RemoteObject.solve(new RemoteObject[] {_clr,BA.numberCast(double.class, _jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("hashCode")),(Object)((bctextengine.__c.getField(false,"Null"))))),_fnt.runMethod(true,"getSize")}, "++",2, 0));
...
try {
		Debug.PushSubsStack("GetBrush (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,786);
...
Debug.CheckDeviceExceptions();if (true) return (__ref.getField(false,"_brushes" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_clr))));};
...
try {
		Debug.PushSubsStack("GetFirstSingleStyle (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,393);
if (RapidSub.canDelegate("getfirstsinglestyle")) { return __ref.runUserSub(false, "bctextengine","getfirstsinglestyle", __ref, _line);}
RemoteObject _firstun = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
Debug.locals.put("Line", _line);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return (_firstun.getField(false,"SingleStyleSections" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));
...
try {
		Debug.PushSubsStack("GetFontMetrics (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,794);
...
RemoteObject _fm = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcfontmetrics");
Debug.locals.put("Fnt", _fnt);
Debug.locals.put("clr", _clr);
...
Debug.JustUpdateDeviceLine();
_key = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_fonttokey" /*RemoteObject*/ ,(Object)(_fnt),(Object)(_clr));Debug.locals.put("key", _key);Debug.locals.put("key", _key);
...
Debug.CheckDeviceExceptions();if (true) return (__ref.getField(false,"_fontmetricscache" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_key))));};
 BA.debugLineNum = 797;BA.debugLine="Dim fm As BCFontMetrics";
Debug.JustUpdateDeviceLine();
_fm = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcfontmetrics");Debug.locals.put("fm", _fm);
...
Debug.JustUpdateDeviceLine();
_fm.setField ("xWidth" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("x")),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"False"))).getField(true,"Width" /*RemoteObject*/ ));
 }else {
 BA.debugLineNum = 807;BA.debugLine="fm.DefaultColorMetrics = GetFontMetrics(Fnt, Def";
Debug.JustUpdateDeviceLine();
_fm.setField ("DefaultColorMetrics" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_getfontmetrics" /*RemoteObject*/ ,(Object)(_fnt),(Object)(__ref.getField(true,"_defaultcolor" /*RemoteObject*/ ))));
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _fm;
...
try {
		Debug.PushSubsStack("GetKernSpaceBetweenChars (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,602);
...
Debug.CheckDeviceExceptions();if (true) return _space;};
...
Debug.JustUpdateDeviceLine();
_w = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(_together),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"True"))).getField(true,"Width" /*RemoteObject*/ );Debug.locals.put("w", _w);Debug.locals.put("w", _w);
...
try {
		Debug.PushSubsStack("getMinGapBetweenLines (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1033);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(true,"_mmingapbetweenlines" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("getSpaceBetweenCharacters (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1011);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mspacebetweencharacters" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0));
...
try {
		Debug.PushSubsStack("getSpaceBetweenLines (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1020);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mspacebetweenlines" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0));
...
try {
		Debug.PushSubsStack("GetUnderlineStyle (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,736);
...
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_defaultunderlinestyle" /*RemoteObject*/ );};
 BA.debugLineNum = 738;BA.debugLine="Return run.Extra.GetDefault(EXTRA_STYLEDUNDERLINE";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return (_run.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)((__ref.getField(true,"_extra_styledunderline" /*RemoteObject*/ ))),(Object)((__ref.getField(false,"_defaultunderlinestyle" /*RemoteObject*/ )))));
...
try {
		Debug.PushSubsStack("HandleConnectedTextRuns (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,408);
...
RemoteObject _cr = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcconnectedruns");
RemoteObject _r = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bctextrun");
RemoteObject _width = RemoteObject.createImmutable(0);
RemoteObject _un = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
RemoteObject _fm = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcfontmetrics");
RemoteObject _connectedwidth = RemoteObject.createImmutable(0);
RemoteObject _u = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
int _i = 0;
RemoteObject _leftoffset = RemoteObject.createImmutable(0);
RemoteObject _single = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection");
Debug.locals.put("Run", _run);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_handletextrun" /*RemoteObject*/ ,(Object)(_r),(Object)(_children),(Object)(_style));
 }
}Debug.locals.put("r", _r);
;
...
Debug.JustUpdateDeviceLine();
_fm = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_getfontmetrics" /*RemoteObject*/ ,(Object)(_run.getField(false,"TextFont" /*RemoteObject*/ )),(Object)(_run.getField(true,"TextColor" /*RemoteObject*/ )));Debug.locals.put("fm", _fm);Debug.locals.put("fm", _fm);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_mergeunbreakables" /*RemoteObject*/ ,(Object)(_u),(Object)((_children.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))))));
 }
}Debug.locals.put("i", _i);
;
...
Debug.JustUpdateDeviceLine();
_single = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createsinglesection" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.getField(false,"_emptytextchars" /*RemoteObject*/ )),(Object)(_fm));Debug.locals.put("single", _single);Debug.locals.put("single", _single);
...
try {
		Debug.PushSubsStack("HandleTextRun (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,446);
...
Debug.JustUpdateDeviceLine();
_unbreakables.runVoidMethod ("Add",(Object)((__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createunbreakable" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.getField(false,"_emptytextchars" /*RemoteObject*/ )),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"True")),(Object)(_style)))));
 };
...
Debug.JustUpdateDeviceLine();
_unbreakables.runVoidMethod ("Add",(Object)((__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createunbreakable" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.getField(false,"_emptytextchars" /*RemoteObject*/ )),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"False")),(Object)(_style)))));
 };
...
try {
		Debug.PushSubsStack("Initialize (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,73);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 76;BA.debugLine="EmptyTextChars = CreateBCTextCharsFromString(\"\")";
Debug.JustUpdateDeviceLine();
__ref.setField ("_emptytextchars" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable(""))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_setspacebetweencharacters" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100))),RemoteObject.createImmutable(100)}, "/",0, 0))));
 BA.debugLineNum = 92;BA.debugLine="setSpaceBetweenLines(20dip)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_setspacebetweenlines" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 20))))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_resizelayers" /*RemoteObject*/ ,(Object)(bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 200)))),(Object)(bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100)))));
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_defaultstyle" /*RemoteObject*/ ,__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createstyle" /*RemoteObject*/ ));
 BA.debugLineNum = 104;BA.debugLine="TagParser.Initialize (Me)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_tagparser" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.bbcodeparser.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)((__ref)));
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("i",_v.runMethod(false,"getTag"), RemoteObject.createImmutable("ng.dsoftlab.stegocam.bbcodeview")) || RemoteObject.solveBoolean("i",_v.runMethod(false,"getTag"), RemoteObject.createImmutable("ng.dsoftlab.stegocam.bblabel"))) { 
...
try {
		Debug.PushSubsStack("IsSpace (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,782);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_textcharequals" /*RemoteObject*/ ,(Object)(_tc),(Object)(RemoteObject.createImmutable(" ")));
...
try {
		Debug.PushSubsStack("IsUNSeparator (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,368);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_un.getField(false,"NotFullTextChars" /*RemoteObject*/ ).getField(true,"Length" /*RemoteObject*/ ),BA.numberCast(double.class, 0))) { 
Debug.CheckDeviceExceptions();if (true) return bctextengine.__c.getField(true,"False");};
 BA.debugLineNum = 370;BA.debugLine="Return WordBoundaries.Contains(un.NotFullTextChar";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(true,"_wordboundaries" /*RemoteObject*/ ).runMethod(true,"contains",(Object)(_un.getField(false,"NotFullTextChars" /*RemoteObject*/ ).getField(false,"Buffer" /*RemoteObject*/ ).getArrayElement(true,_un.getField(false,"NotFullTextChars" /*RemoteObject*/ ).getField(true,"StartIndex" /*RemoteObject*/ ))));
...
try {
		Debug.PushSubsStack("LoadArabicData (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1113);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 1117;BA.debugLine="ArabicCharsConnectedPrev.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_split.getArrayElement(true,BA.numberCast(int.class, 0))),(Object)(BA.numberCast(int.class, 16))))));
 }else {
...
try {
		Debug.PushSubsStack("LoadData (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1187);
...
Debug.JustUpdateDeviceLine();
_set.runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
Debug.JustUpdateDeviceLine();
_set.runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_line),(Object)(BA.numberCast(int.class, 16))))));
 }else {
...
Debug.JustUpdateDeviceLine();
_set.runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_add" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable((_a))));
 }
}Debug.locals.put("a", _a);
;
 };
...
try {
		Debug.PushSubsStack("MergeUnbreakables (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,545);
...
try {
		Debug.PushSubsStack("MightBeAnEmoji (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,915);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToBoolean(RemoteObject.solveBoolean("g",_cp,BA.numberCast(double.class, ((int)0x231a))) || RemoteObject.solveBoolean(">",_c.runMethod(true,"length"),BA.numberCast(double.class, 1)));
...
try {
		Debug.PushSubsStack("OrganizeLines (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,236);
...
RemoteObject _linestyle = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection");
RemoteObject _last = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
...
Debug.JustUpdateDeviceLine();
_linestyle = __ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_getfirstsinglestyle" /*RemoteObject*/ ,(Object)(_line));Debug.locals.put("linestyle", _linestyle);Debug.locals.put("linestyle", _linestyle);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_isspace" /*RemoteObject*/ ,(Object)(_last.getField(false,"NotFullTextChars" /*RemoteObject*/ ))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("OrganizeRTLParagraph (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,300);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_addltritems" /*RemoteObject*/ ,(Object)(_ltrlist),(Object)(_newlist));
...
try {
		Debug.PushSubsStack("OrganizeSingleStyles (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,373);
...
try {
		Debug.PushSubsStack("OrganizeUnbreakables (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,505);
...
RemoteObject _un = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
RemoteObject _i = RemoteObject.createImmutable(0);
RemoteObject _nextun = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcunbreakabletext");
RemoteObject _singlestyle = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bcsinglestylesection");
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_mergeunbreakables" /*RemoteObject*/ ,(Object)(_un),(Object)(_nextun));
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_textcharequals" /*RemoteObject*/ ,(Object)(_un.getField(false,"NotFullTextChars" /*RemoteObject*/ )),(Object)(BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 13)))))).<Boolean>get().booleanValue()) { 
if (true) continue;};
 BA.debugLineNum = 522;BA.debugLine="If TextCharEquals(un.NotFullTextChars, Chr(10))";
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_textcharequals" /*RemoteObject*/ ,(Object)(_un.getField(false,"NotFullTextChars" /*RemoteObject*/ )),(Object)(BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 10)))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 523;BA.debugLine="CreateLine(p)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createline" /*RemoteObject*/ ,(Object)(_p));
...
try {
		Debug.PushSubsStack("Prepare (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,168);
...
RemoteObject _run = RemoteObject.declareNull("ng.dsoftlab.stegocam.bctextengine._bctextrun");
Debug.locals.put("Runs", _runs);
Debug.locals.put("Style", _style);
...
Debug.JustUpdateDeviceLine();
_par = RemoteObject.createNew ("ng.dsoftlab.stegocam.bctextengine._bcparagraph");Debug.locals.put("par", _par);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_handleconnectedtextruns" /*RemoteObject*/ ,(Object)(_run),(Object)(_unbreakeables),(Object)(_style));
 }else {
 BA.debugLineNum = 180;BA.debugLine="HandleTextRun(run, unbreakeables, Style)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_handletextrun" /*RemoteObject*/ ,(Object)(_run),(Object)(_unbreakeables),(Object)(_style));
 };
 }
}Debug.locals.put("run", _run);
;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_createline" /*RemoteObject*/ ,(Object)(_par));
 BA.debugLineNum = 184;BA.debugLine="OrganizeUnbreakables(par, unbreakeables)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_organizeunbreakables" /*RemoteObject*/ ,(Object)(_par),(Object)(_unbreakeables));
 BA.debugLineNum = 185;BA.debugLine="OrganizeLines(par)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_organizelines" /*RemoteObject*/ ,(Object)(_par));
 BA.debugLineNum = 186;BA.debugLine="OrganizeSingleStyles(par)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_organizesinglestyles" /*RemoteObject*/ ,(Object)(_par));
...
__ref.runClassMethod (ng.dsoftlab.stegocam.bctextengine.class, "_organizertlparagraph" /*RemoteObject*/ ,(Object)(_par));};
...
try {
		Debug.PushSubsStack("PrepareForLazyDrawing (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,191);
...
try {
		Debug.PushSubsStack("PreprocessArabic (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1135);
...
RemoteObject _arabicchars = RemoteObject.declareNull("ng.dsoftlab.stegocam.b4xbitset");
RemoteObject _arabicnonlinked = RemoteObject.declareNull("ng.dsoftlab.stegocam.b4xbitset");
...
Debug.JustUpdateDeviceLine();
_arabicchars = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xbitset");Debug.locals.put("ArabicChars", _arabicchars);
_arabicnonlinked = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xbitset");Debug.locals.put("ArabicNonLinked", _arabicnonlinked);
...
Debug.JustUpdateDeviceLine();
_arabicchars.runClassMethod (ng.dsoftlab.stegocam.b4xbitset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_length));
 BA.debugLineNum = 1149;BA.debugLine="ArabicNonLinked.Initialize(Length)";
Debug.JustUpdateDeviceLine();
_arabicnonlinked.runClassMethod (ng.dsoftlab.stegocam.b4xbitset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_length));
 };
 BA.debugLineNum = 1151;BA.debugLine="ArabicChars.Set(i, True)";
Debug.JustUpdateDeviceLine();
_arabicchars.runClassMethod (ng.dsoftlab.stegocam.b4xbitset.class, "_set" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i)),(Object)(bctextengine.__c.getField(true,"True")));
 BA.debugLineNum = 1152;BA.debugLine="If ArabicNonLinkedLetters.Contains(chars(i)) Th";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_chars.getArrayElement(true,BA.numberCast(int.class, _i))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1153;BA.debugLine="ArabicNonLinked.Set(i, True)";
Debug.JustUpdateDeviceLine();
_arabicnonlinked.runClassMethod (ng.dsoftlab.stegocam.b4xbitset.class, "_set" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i)),(Object)(bctextengine.__c.getField(true,"True")));
 };
 };
 }
}Debug.locals.put("i", _i);
...
__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((_chars.getArrayElement(true,BA.numberCast(int.class, _i)))));};
 };
...
try {
		Debug.PushSubsStack("PrintTextChars (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1178);
...
Debug.JustUpdateDeviceLine();
bctextengine.__c.runVoidMethod ("LogImpl","915728646",_sb.runMethod(true,"ToString"),0);
...
try {
		Debug.PushSubsStack("RecolorEdgesOfConnectedCharacters (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,889);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_c))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("ReleaseAsyncBC (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,677);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_bc)),(Object)((bctextengine.__c.getField(true,"False"))));
...
try {
		Debug.PushSubsStack("ResizeCharBC (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,741);
...
try {
		Debug.PushSubsStack("ResizeImageView (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,227);
...
try {
		Debug.PushSubsStack("ResizeLayers (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("setMinGapBetweenLines (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1029);
...
try {
		Debug.PushSubsStack("setSpaceBetweenCharacters (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1015);
...
try {
		Debug.PushSubsStack("setSpaceBetweenLines (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1024);
...
try {
		Debug.PushSubsStack("TextCharEquals (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1105);
...
try {
		Debug.PushSubsStack("TextCharsSubstring (bctextengine) ","bctextengine",33,__ref.getField(false, "ba"),__ref,1101);
