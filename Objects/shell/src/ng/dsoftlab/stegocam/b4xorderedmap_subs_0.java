...
try {
		Debug.PushSubsStack("Clear (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("ContainsKey (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,46);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runMethod(true,"ContainsKey",(Object)(_key));
...
try {
		Debug.PushSubsStack("Get (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,37);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(_key));
...
try {
		Debug.PushSubsStack("GetDataForSerializator (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,65);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return (RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(__ref.getField(false,"_map" /*RemoteObject*/ ).getObject()),(__ref.getField(false,"_list" /*RemoteObject*/ ).getObject())}));
...
try {
		Debug.PushSubsStack("GetDefault (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,42);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)(_key),(Object)(_defaultvalue));
...
try {
		Debug.PushSubsStack("getKeys (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,32);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_list" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("getSize (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,50);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runMethod(true,"getSize");
...
try {
		Debug.PushSubsStack("getValues (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("Initialize (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,6);
...
try {
		Debug.PushSubsStack("Put (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,12);
...
try {
		Debug.PushSubsStack("Remove (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("SetDataFromSerializator (b4xorderedmap) ","b4xorderedmap",22,__ref.getField(false, "ba"),__ref,70);
