...
try {
		Debug.PushSubsStack("Initialize (b4xcomparatorsort) ","b4xcomparatorsort",21,__ref.getField(false, "ba"),__ref,4);
...
try {
		Debug.PushSubsStack("Partition (b4xcomparatorsort) ","b4xcomparatorsort",21,__ref.getField(false, "ba"),__ref,30);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xcomparatorsort.class, "_swap" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(_pivotindex),(Object)(RemoteObject.solve(new RemoteObject[] {_length,RemoteObject.createImmutable(1)}, "-",1, 1)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xcomparatorsort.class, "_swap" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(RemoteObject.solve(new RemoteObject[] {_l,RemoteObject.createImmutable(1)}, "-",1, 1)),(Object)(BA.numberCast(int.class, _i)));
 };
 }
}Debug.locals.put("i", _i);
;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xcomparatorsort.class, "_swap" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(RemoteObject.solve(new RemoteObject[] {_length,RemoteObject.createImmutable(1)}, "-",1, 1)),(Object)(_l));
 BA.debugLineNum = 41;BA.debugLine="Return L";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _l;
...
try {
		Debug.PushSubsStack("QuickSort (b4xcomparatorsort) ","b4xcomparatorsort",21,__ref.getField(false, "ba"),__ref,21);
...
Debug.JustUpdateDeviceLine();
_r = __ref.runClassMethod (ng.dsoftlab.stegocam.b4xcomparatorsort.class, "_partition" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(_length),(Object)(_pivotindex),(Object)(_comparator));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
 BA.debugLineNum = 25;BA.debugLine="QuickSort(Data, StartIndex, r, Comparator)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xcomparatorsort.class, "_quicksort" /*RemoteObject*/ ,(Object)(_data),(Object)(_startindex),(Object)(_r),(Object)(_comparator));
...
try {
		Debug.PushSubsStack("Sort (b4xcomparatorsort) ","b4xcomparatorsort",21,__ref.getField(false, "ba"),__ref,12);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xcomparatorsort.class, "_quicksort" /*RemoteObject*/ ,(Object)(_data),(Object)(BA.numberCast(int.class, 0)),(Object)(_data.runMethod(true,"getSize")),(Object)(_comparator));
...
try {
		Debug.PushSubsStack("Swap (b4xcomparatorsort) ","b4xcomparatorsort",21,__ref.getField(false, "ba"),__ref,44);
