...
try {
		Debug.PushSubsStack("Base_OnInterceptTouchEvent (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,97);
...
Debug.CheckDeviceExceptions();if (true) return b4xdrawer.__c.getField(true,"False");};
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return b4xdrawer.__c.getField(true,"True");
 };
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(true,"_handlingswipe" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Base_OnTouchEvent (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,66);
...
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xdrawer.class, "_setleftopen" /*RemoteObject*/ ,(Object)(b4xdrawer.__c.getField(true,"False")));};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xdrawer.class, "_changeoffset" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, __ref.getField(false,"_mleftpanel" /*RemoteObject*/ ).runMethod(true,"getLeft"))),(Object)(b4xdrawer.__c.getField(true,"False")),(Object)(b4xdrawer.__c.getField(true,"False")));
 };
...
try {
		Debug.PushSubsStack("ChangeOffset (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,175);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xdrawer.class, "_setisopen" /*RemoteObject*/ ,(Object)(b4xdrawer.__c.getField(true,"False")));
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xdrawer.class, "_setisopen" /*RemoteObject*/ ,(Object)(b4xdrawer.__c.getField(true,"True")));
 };
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runVoidMethod ("SetColorAnimated",(Object)(_duration),(Object)(__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"getColor")),(Object)(__ref.runClassMethod (ng.dsoftlab.stegocam.b4xdrawer.class, "_offsettocolor" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _x)))));
 }else {
 BA.debugLineNum = 208;BA.debugLine="mDarkPanel.Color = OffsetToColor(x)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdarkpanel" /*RemoteObject*/ ).runMethod(true,"setColor",__ref.runClassMethod (ng.dsoftlab.stegocam.b4xdrawer.class, "_offsettocolor" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _x))));
...
try {
		Debug.PushSubsStack("getCenterPanel (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,241);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_mcenterpanel" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("getGestureEnabled (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,253);
...
try {
		Debug.PushSubsStack("getLeftOpen (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,226);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(true,"_isopen" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("getLeftPanel (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,237);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_mleftpanel" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Initialize (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("LeftPanel_Click (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,60);
...
try {
		Debug.PushSubsStack("OffsetToColor (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,221);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Color_ARGB",(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(100),_visible}, "*",0, 0))),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("Resize (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,245);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_isopen" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xdrawer.class, "_changeoffset" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, -(double) (0 + __ref.getField(true,"_msidewidth" /*RemoteObject*/ ).<Integer>get().intValue()))),(Object)(b4xdrawer.__c.getField(true,"False")),(Object)(b4xdrawer.__c.getField(true,"True")));};
...
try {
		Debug.PushSubsStack("setGestureEnabled (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,257);
...
try {
		Debug.PushSubsStack("SetIsOpen (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,213);
...
try {
		Debug.PushSubsStack("setLeftOpen (b4xdrawer) ","b4xdrawer",24,__ref.getField(false, "ba"),__ref,230);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xdrawer.class, "_changeoffset" /*RemoteObject*/ ,(Object)(_x),(Object)(b4xdrawer.__c.getField(true,"False")),(Object)(b4xdrawer.__c.getField(true,"False")));
