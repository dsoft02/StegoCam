...
b4xcache._data = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xorderedmap");__ref.setField("_data",b4xcache._data);
...
try {
		Debug.PushSubsStack("ContainsKey (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,66);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_containskey" /*RemoteObject*/ ,(Object)((_key)));
...
try {
		Debug.PushSubsStack("CreateB4XCacheItem (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,102);
if (RapidSub.canDelegate("createb4xcacheitem")) { return __ref.runUserSub(false, "b4xcache","createb4xcacheitem", __ref, _value, _key);}
RemoteObject _t1 = RemoteObject.declareNull("ng.dsoftlab.stegocam.b4xcache._b4xcacheitem");
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("ng.dsoftlab.stegocam.b4xcache._b4xcacheitem");Debug.locals.put("t1", _t1);
...
try {
		Debug.PushSubsStack("Get (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,24);
if (RapidSub.canDelegate("get")) { return __ref.runUserSub(false, "b4xcache","get", __ref, _key);}
RemoteObject _ci = RemoteObject.declareNull("ng.dsoftlab.stegocam.b4xcache._b4xcacheitem");
Debug.locals.put("Key", _key);
...
Debug.JustUpdateDeviceLine();
_ci = (__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_key))));Debug.locals.put("ci", _ci);Debug.locals.put("ci", _ci);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _ci.getField(false,"Value" /*RemoteObject*/ );
 };
 BA.debugLineNum = 30;BA.debugLine="Return Null";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return b4xcache.__c.getField(false,"Null");
...
try {
		Debug.PushSubsStack("getMaxSize (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,19);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(true,"_mmaxsize" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Initialize (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,9);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
try {
		Debug.PushSubsStack("IsEternal (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,60);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToBoolean(((RemoteObject.solveBoolean("n",_ci)) ? ((b4xcache.__c.getField(true,"False"))) : ((_ci.getField(true,"Eternal" /*RemoteObject*/ )))));
...
try {
		Debug.PushSubsStack("Keys (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,98);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Put (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,35);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (ng.dsoftlab.stegocam.b4xcache.class, "_iseternal" /*RemoteObject*/ ,(Object)(_key)).<Boolean>get().booleanValue()) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_key)),(Object)((__ref.runClassMethod (ng.dsoftlab.stegocam.b4xcache.class, "_createb4xcacheitem" /*RemoteObject*/ ,(Object)(_value),(Object)(_key)))));
 BA.debugLineNum = 38;BA.debugLine="TrimIfOversize";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ng.dsoftlab.stegocam.b4xcache.class, "_trimifoversize" /*RemoteObject*/ );
 BA.debugLineNum = 39;BA.debugLine="Return Value";
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return _value;
...
try {
		Debug.PushSubsStack("PutEternal (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,44);
...
Debug.JustUpdateDeviceLine();
_ci = __ref.runClassMethod (ng.dsoftlab.stegocam.b4xcache.class, "_createb4xcacheitem" /*RemoteObject*/ ,(Object)(_value),(Object)(_key));Debug.locals.put("ci", _ci);Debug.locals.put("ci", _ci);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_key)),(Object)((_ci)));
...
try {
		Debug.PushSubsStack("Remove (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,55);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_key)));
...
try {
		Debug.PushSubsStack("RemoveOldItems (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,82);
...
_values = __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_getvalues" /*RemoteObject*/ );Debug.locals.put("values", _values);Debug.locals.put("values", _values);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_ci.getField(true,"Key" /*RemoteObject*/ ))));
 };
 }
}Debug.locals.put("ci", _ci);
;
...
try {
		Debug.PushSubsStack("setMaxSize (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("Size (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,93);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_getsize" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("TrimIfOversize (b4xcache) ","b4xcache",19,__ref.getField(false, "ba"),__ref,70);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (ng.dsoftlab.stegocam.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((((_values.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))))).getField(true,"Key" /*RemoteObject*/ ))));
 }
}Debug.locals.put("i", _i);
;
 };
