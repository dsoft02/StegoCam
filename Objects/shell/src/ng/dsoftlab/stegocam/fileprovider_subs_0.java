...
try {
		Debug.PushSubsStack("GetFileUri (fileprovider) ","fileprovider",34,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("Initialize (fileprovider) ","fileprovider",34,__ref.getField(false, "ba"),__ref,8);
...
Debug.JustUpdateDeviceLine();
fileprovider.__c.runVoidMethod ("LogImpl","915925258",(RemoteObject.concat(RemoteObject.createImmutable("Using FileProvider? "),fileprovider.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_usefileprovider" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("SetFileUriAsIntentData (fileprovider) ","fileprovider",34,__ref.getField(false, "ba"),__ref,40);
...
Debug.JustUpdateDeviceLine();
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setData")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.runClassMethod (ng.dsoftlab.stegocam.fileprovider.class, "_getfileuri" /*RemoteObject*/ ,(Object)(_filename))})));
