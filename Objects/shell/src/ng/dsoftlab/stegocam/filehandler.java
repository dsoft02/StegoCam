...
public class filehandler {
    ...
    public static PCBA staticBA = new PCBA(null, filehandler.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _ion = RemoteObject.declareNull("Object");
public static RemoteObject _oldintent = RemoteObject.declareNull("anywheresoftware.b4a.objects.IntentWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"ion",_ref.getField(false, "_ion"),"OldIntent",_ref.getField(false, "_oldintent")};
}
}