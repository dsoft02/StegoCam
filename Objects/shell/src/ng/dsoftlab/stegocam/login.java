...
public class login implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("login"), "ng.dsoftlab.stegocam.login");
	}
...
public static RemoteObject _btnresetpin = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _btnsignin = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
public static RemoteObject _imgfingerprint = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
...
public static ng.dsoftlab.stegocam.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",login.mostCurrent._activity,"ACToolBarLight1",login.mostCurrent._actoolbarlight1,"B4XCollections",Debug.moduleToString(ng.dsoftlab.stegocam.b4xcollections.class),"Biometric",login._biometric,"btnResetPin",login.mostCurrent._btnresetpin,"btnSignin",login.mostCurrent._btnsignin,"config",Debug.moduleToString(ng.dsoftlab.stegocam.config.class),"DateUtils",login.mostCurrent._dateutils,"encode",Debug.moduleToString(ng.dsoftlab.stegocam.encode.class),"forgotpin",Debug.moduleToString(ng.dsoftlab.stegocam.forgotpin.class),"history",Debug.moduleToString(ng.dsoftlab.stegocam.history.class),"HttpUtils2Service",Debug.moduleToString(ng.dsoftlab.stegocam.httputils2service.class),"IME",login.mostCurrent._ime,"imgFingerprint",login.mostCurrent._imgfingerprint,"imgIcon",login.mostCurrent._imgicon,"Label3",login.mostCurrent._label3,"lblErrorMsg",login.mostCurrent._lblerrormsg,"lblShowPassword",login.mostCurrent._lblshowpassword,"Main",Debug.moduleToString(ng.dsoftlab.stegocam.main.class),"mainmenu",Debug.moduleToString(ng.dsoftlab.stegocam.mainmenu.class),"PinChange",Debug.moduleToString(ng.dsoftlab.stegocam.pinchange.class),"pinreset",Debug.moduleToString(ng.dsoftlab.stegocam.pinreset.class),"PinSetup",Debug.moduleToString(ng.dsoftlab.stegocam.pinsetup.class),"securityquestion",Debug.moduleToString(ng.dsoftlab.stegocam.securityquestion.class),"settings",Debug.moduleToString(ng.dsoftlab.stegocam.settings.class),"SharedPrefs",login.mostCurrent._sharedprefs,"Starter",Debug.moduleToString(ng.dsoftlab.stegocam.starter.class),"ToolbarHelper",login.mostCurrent._toolbarhelper,"txtPin",login.mostCurrent._txtpin,"userPin",login.mostCurrent._userpin,"XUIViewsUtils",Debug.moduleToString(ng.dsoftlab.stegocam.xuiviewsutils.class)};
}
}