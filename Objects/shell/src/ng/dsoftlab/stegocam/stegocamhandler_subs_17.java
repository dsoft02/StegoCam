...
public class stegocamhandler_subs_17 {
...
Debug.ShouldStop(2);
_secretmessage = stegocamhandler.__c.getField(false,"Bit").runMethod(false,"InputStreamToBytes",(Object)((stegocamhandler.__c.getField(false,"File").runMethod(false,"OpenInput",(Object)(_secretfile),(Object)(RemoteObject.createImmutable(""))).getObject())));Debug.locals.put("SecretMessage", _secretmessage);Debug.locals.put("SecretMessage", _secretmessage);
